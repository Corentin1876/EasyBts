...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <a href="https://www.systeme-de-design.gouv.fr/version-courante/fr/modeles/blocs-fonctionnels/nationalite" rel="noopener external" target="_blank" title="${getBlankTitle('Documentation')}">Documentation</a>
    </div>
    <div class="fr-mb-12w">
        <div class="fr-container">
            ...
            <div class="fr-grid-row fr-grid-row--gutters fr-grid-row--center fr-mb-6v">
                <div class="fr-col-md-8 fr-col-xl-6 fr-col-12">
                    <fieldset class="fr-fieldset" id="nationality-7389" aria-labelledby="nationality-7389-legend nationality-7389-messages">
                        <legend class="fr-sr-only" id="nationality-7389-legend">
                            Nationalité
                        </legend>
                        <div class="fr-fieldset__element">
                            <div class="fr-select-group">
                                <label class="fr-label" for="nationality-select-7388">
                                    Nationalité
                                </label>
                                <select class="fr-select" aria-describedby="nationality-select-7388-messages" id="nationality-select-7388" name="country">
                                ...
                                <div class="fr-messages-group" id="nationality-select-7388-messages" aria-live="polite">
                                </div>
                            </div>
                        </div>
                        <div class="fr-messages-group" id="nationality-7389-messages" aria-live="polite">
                        </div>
                    </fieldset>
                </div>
            </div>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7392">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-7392">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset" id="nationality-7391" aria-labelledby="nationality-7391-legend nationality-7391-messages"&gt;
    &lt;legend class="fr-sr-only" id="nationality-7391-legend"&gt;
        Nationalité
    &lt;/legend&gt;
    &lt;div class="fr-fieldset__element"&gt;
        &lt;div class="fr-select-group"&gt;
            &lt;label class="fr-label" for="nationality-select-7390"&gt;
                Nationalité
            &lt;/label&gt;
            &lt;select class="fr-select" aria-describedby="nationality-select-7390-messages" id="nationality-select-7390" name="country"&gt;
                &lt;option value="" selected disabled&gt;Sélectionner une option&lt;/option&gt;
                &lt;option value="FR"&gt;Française&lt;/option&gt;
                &lt;option value="DE"&gt;Allemande&lt;/option&gt;
                &lt;option value="IT"&gt;Italienne&lt;/option&gt;
                &lt;option value="ES"&gt;Espagnole&lt;/option&gt;
            &lt;/select&gt;
            &lt;div class="fr-messages-group" id="nationality-select-7390-messages" aria-live="polite"&gt;
            &lt;/div&gt;
        &lt;/div&gt;
    &lt;/div&gt;
    &lt;div class="fr-messages-group" id="nationality-7391-messages" aria-live="polite"&gt;
    &lt;/div&gt;
&lt;/fieldset&gt;
</code></pre>
                            </div>
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button aria-controls="fr-theme-modal" title="Fermer" type="button" id="button-7393" class="fr-btn--close fr-btn">Fermer</button>
                        </div>
