...
<head>
    ...
    <title>Bloc fonctionnel de téléphone - Système de design</title>
...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <h1>Bloc fonctionnel de téléphone (tel)</h1>
        <p>La demande de numéro de téléphone est un bloc fonctionnel qui permet de saisir un numéro de téléphone.</p>
        <a href="https://www.systeme-de-design.gouv.fr/version-courante/fr/modeles/blocs-fonctionnels/tel" rel="noopener external" target="_blank" title="${getBlankTitle('Documentation')}">Documentation</a>
    </div>
    <div class="fr-mb-12w">
        <div class="fr-container">
            ...
            <div class="fr-mb-6v">
                <div class="fr-input-group" id="input-group-7667">
                    <label class="fr-label" for="tel-7666">
                        Numéro de téléphone
                        <span class="fr-hint-text">Format attendu : (+33) 1 22 33 44 55</span>
                    </label>
                    <input class="fr-input" autocomplete="tel" aria-describedby="tel-7666-messages" id="tel-7666" type="tel">
                    <div class="fr-messages-group" id="tel-7666-messages" aria-live="polite">
                    </div>
                </div>
            </div>
            <div class="fr-mb-12v">
                <section class="fr-accordion">
                    ...
                    <div class="fr-collapse" id="snippet-7670">
                        <pre class=" language-html"><code>&lt;div class="fr-input-group" id="input-group-7669"&gt;
    &lt;label class="fr-label" for="tel-7668"&gt;
        Numéro de téléphone
        &lt;span class="fr-hint-text"&gt;Format attendu : (+33) 1 22 33 44 55&lt;/span&gt;
    &lt;/label&gt;
    &lt;input class="fr-input" autocomplete="tel" aria-describedby="tel-7668-messages" id="tel-7668" type="tel"&gt;
    &lt;div class="fr-messages-group" id="tel-7668-messages" aria-live="polite"&gt;
    &lt;/div&gt;
&lt;/div&gt;
</code></pre>
                    </div>
            ...
            <div class="fr-mb-6v">
                <div class="fr-input-group fr-input-group--error" id="input-group-7672">
                    <label class="fr-label" for="tel-7671">
                        Numéro de téléphone
                        <span class="fr-hint-text">Format attendu : (+33) 1 22 33 44 55</span>
                    </label>
                    <input class="fr-input" autocomplete="tel" aria-describedby="tel-7671-messages" id="tel-7671" type="tel">
                    <div class="fr-messages-group" id="tel-7671-messages" aria-live="polite">
                        <p class="fr-message fr-message--error" id="tel-7671-message-error">Le format de numéro de téléphone saisie n’est pas valide. Le format attendu est : (+33) 1 22 33 44 55</p>
                    </div>
                </div>
            </div>
            <div class="fr-mb-12v">
                <section class="fr-accordion">
                    ...
                    <div class="fr-collapse" id="snippet-7675">
                        <pre class=" language-html"><code>&lt;div class="fr-input-group fr-input-group--error" id="input-group-7674"&gt;
    &lt;label class="fr-label" for="tel-7673"&gt;
        Numéro de téléphone
        &lt;span class="fr-hint-text"&gt;Format attendu : (+33) 1 22 33 44 55&lt;/span&gt;
    &lt;/label&gt;
    &lt;input class="fr-input" autocomplete="tel" aria-describedby="tel-7673-messages" id="tel-7673" type="tel"&gt;
    &lt;div class="fr-messages-group" id="tel-7673-messages" aria-live="polite"&gt;
        &lt;p class="fr-message fr-message--error" id="tel-7673-message-error"&gt;Le format de numéro de téléphone saisie n’est pas valide. Le format attendu est : (+33) 1 22 33 44 55&lt;/p&gt;
    &lt;/div&gt;
&lt;/div&gt;
</code></pre>
                    </div>
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button aria-controls="fr-theme-modal" title="Fermer" type="button" id="button-7676" class="fr-btn--close fr-btn">Fermer</button>
                        </div>
