...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container">
        <ul class="fr-col-12">
            <li class="fr-mb-1w">
                <a href='./pictograms-accessibility/'>Pictogrammes Accessibilité (pictograms-accessibility)</a>
            </li>
            <li class="fr-mb-1w">
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button aria-controls="fr-theme-modal" title="Fermer" type="button" id="button-11532" class="fr-btn--close fr-btn">Fermer</button>
                        </div>
