...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <a href="https://www.systeme-de-design.gouv.fr/version-courante/fr/composants/indicateur-d-etapes" rel="noopener external" target="_blank" title="${getBlankTitle('Documentation')}">Documentation</a>
    </div>
    <div class="fr-mb-12w">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-3818">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-3818">
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-3819">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-3819">
                                <pre class=" language-html"><code>&lt;div class="fr-stepper"&gt;
    &lt;h2 class="fr-stepper__title"&gt;
        Titre de l’étape en cours
        &lt;span class="fr-stepper__state"&gt;Étape 2 sur 8&lt;/span&gt;
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button aria-controls="fr-theme-modal" title="Fermer" type="button" id="button-3820" class="fr-btn--close fr-btn">Fermer</button>
                        </div>
