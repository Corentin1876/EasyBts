...
<body id="top" class="fr-mb-12w">
  ...
  function preventSubmit(e) {
                    ...
                    <form onsubmit="return preventSubmit(event)">
                        ...
                        <div class="fr-mb-6v">
                            <fieldset class="fr-fieldset" id="text" aria-labelledby="text-legend text-messages">
                                ...
                                <div class="fr-fieldset__element">
                                    <div class="fr-input-group" id="input-group-3750">
                                ...
                                <div class="fr-fieldset__element">
                                    <div class="fr-input-group" id="input-group-3751">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-3755">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-3755">
                                    <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset" id="text" aria-labelledby="text-legend text-messages"&gt;
    &lt;legend class="fr-fieldset__legend" id="text-legend"&gt;
        Légende pour l’ensemble des éléments
    &lt;/legend&gt;
    &lt;div class="fr-fieldset__element"&gt;
        &lt;div class="fr-input-group" id="input-group-3752"&gt;
            &lt;label class="fr-label" for="text-1"&gt;
                Libellé champ de saisie
            &lt;/label&gt;
            &lt;input class="fr-input" aria-describedby="text-1-messages" name="text-1" id="text-1" type="text"&gt;
    ...
    &lt;/div&gt;
    &lt;div class="fr-fieldset__element"&gt;
        &lt;div class="fr-input-group" id="input-group-3753"&gt;
            &lt;label class="fr-label" for="text-2"&gt;
                Libellé champ de saisie
            &lt;/label&gt;
            &lt;input class="fr-input" aria-describedby="text-2-messages" name="text-2" id="text-2" type="text"&gt;
    ...
    &lt;/div&gt;
    &lt;div class="fr-fieldset__element"&gt;
        &lt;div class="fr-input-group" id="input-group-3754"&gt;
            &lt;label class="fr-label" for="text-3"&gt;
                Libellé champ de saisie
            &lt;/label&gt;
            &lt;input class="fr-input" aria-describedby="text-3-messages" name="text-3" id="text-3" type="text"&gt;
...
&lt;/fieldset&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-3756">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-3756">
...
&lt;/fieldset&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-3757">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-3757">
...
&lt;/fieldset&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-3758">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-3758">
...
&lt;/fieldset&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-3759">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-3759">
...
&lt;/fieldset&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-3760">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-3760">
...
&lt;/fieldset&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-3761">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-3761">
...
&lt;/fieldset&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-3762">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-3762">
...
&lt;/fieldset&gt;
                        ...
                        <div class="fr-mb-6v">
                            <fieldset class="fr-fieldset" id="text-disabled" disabled aria-labelledby="text-disabled-legend text-disabled-messages">
                                ...
                                <div class="fr-fieldset__element">
                                    <div class="fr-input-group" id="input-group-3763">
                                ...
                                <div class="fr-fieldset__element">
                                    <div class="fr-input-group" id="input-group-3764">
                                ...
                                <div class="fr-fieldset__element">
                                    <div class="fr-input-group" id="input-group-3765">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-3769">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-3769">
    ...
    &lt;/legend&gt;
    &lt;div class="fr-fieldset__element"&gt;
        &lt;div class="fr-input-group" id="input-group-3766"&gt;
            &lt;label class="fr-label" for="text-disabled-1"&gt;
                Libellé champ de saisie
                &lt;span class="fr-hint-text"&gt;Texte de description additionnel&lt;/span&gt;
            &lt;/label&gt;
    ...
    &lt;/div&gt;
    &lt;div class="fr-fieldset__element"&gt;
        &lt;div class="fr-input-group" id="input-group-3767"&gt;
            &lt;label class="fr-label" for="text-disabled-2"&gt;
                Libellé champ de saisie
                &lt;span class="fr-hint-text"&gt;Texte de description additionnel&lt;/span&gt;
            &lt;/label&gt;
    ...
    &lt;/div&gt;
    &lt;div class="fr-fieldset__element"&gt;
        &lt;div class="fr-input-group" id="input-group-3768"&gt;
            &lt;label class="fr-label" for="text-disabled-3"&gt;
                Libellé champ de saisie
                &lt;span class="fr-hint-text"&gt;Texte de description additionnel&lt;/span&gt;
            &lt;/label&gt;
...
&lt;/fieldset&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-3770">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-3770">
...
&lt;/fieldset&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-3771">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-3771">
...
&lt;/fieldset&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-3772">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-3772">
                                    <pre class=" language-html"><code>&lt;button title="Envoyer le formulaire" type="submit" class="fr-btn"&gt;Envoyer&lt;/button&gt;
</code></pre>
                                </div>
                            </section>
                        </div>
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-3773">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-3773">
                                    <pre class=" language-html"><code>&lt;input title="Envoyer le formulaire" type="submit" value="Envoyer" class="fr-btn"&gt;
</code></pre>
                                </div>
                            </section>
                        </div>
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-3774">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-3774">
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button aria-controls="fr-theme-modal" title="Fermer" type="button" id="button-3775" class="fr-btn--close fr-btn">Fermer</button>
                        </div>
