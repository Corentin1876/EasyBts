...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <a href="https://www.systeme-de-design.gouv.fr/version-courante/fr/composants/contenu-medias" rel="noopener external" target="_blank" title="${getBlankTitle('Documentation')}">Documentation</a>
    </div>
    <div class="fr-mb-12w">
        <div class="fr-container">
            <div class="fr-grid-row fr-grid-row--center">
                <div class="fr-col-md-8 fr-col-12">
                    ...
                    <div class="fr-mb-6v">
                        <figure role="group" class="fr-content-media" id="media-1568" aria-label="Description / Source">
                            ...
                            <figcaption class="fr-content-media__caption">
                                Description / Source
                                <a id="link-1569" href="#" class="fr-link">Libellé lien</a>
                            </figcaption>
                        </figure>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            ...
                            <div class="fr-collapse" id="snippet-1572">
                                <pre class=" language-html"><code>&lt;figure role="group" class="fr-content-media" id="media-1570" aria-label="Description / Source"&gt;
    &lt;div class="fr-content-media__img"&gt;
        &lt;img class="fr-responsive-img fr-ratio-16x9" src="../../../example/img/placeholder.16x9.png" alt="[À MODIFIER - vide ou texte alternatif de l’image]" /&gt;
        &lt;!-- L’alternative de l’image (attribut alt) doit toujours être présente, sa valeur peut-être vide (image n’apportant pas de sens supplémentaire au contexte) ou non (porteuse de texte ou apportant du sens) selon votre contexte --&gt;
    &lt;/div&gt;
...
&lt;/figure&gt;
                    ...
                    <div class="fr-mb-6v">
                        <figure role="group" class="fr-content-media fr-content-media--sm" id="media-1573" aria-label="Description / Source">
                            <div class="fr-content-media__img">
                                <img class="fr-responsive-img fr-ratio-16x9" src="../../../example/img/placeholder.16x9.png" alt="[À MODIFIER - vide ou texte alternatif de l’image]" />
                                <!-- L’alternative de l’image (attribut alt) doit toujours être présente, sa valeur peut-être vide (image n’apportant pas de sens supplémentaire au contexte) ou non (porteuse de texte ou apportant du sens) selon votre contexte -->
                            </div>
                            <figcaption class="fr-content-media__caption">
                                Description / Source
                                <a id="link-1574" href="#" class="fr-link">Libellé lien</a>
                            </figcaption>
                        </figure>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1577">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1577">
                                <pre class=" language-html"><code>&lt;figure role="group" class="fr-content-media fr-content-media--sm" id="media-1575" aria-label="Description / Source"&gt;
    &lt;div class="fr-content-media__img"&gt;
        &lt;img class="fr-responsive-img fr-ratio-16x9" src="../../../example/img/placeholder.16x9.png" alt="[À MODIFIER - vide ou texte alternatif de l’image]" /&gt;
        &lt;!-- L’alternative de l’image (attribut alt) doit toujours être présente, sa valeur peut-être vide (image n’apportant pas de sens supplémentaire au contexte) ou non (porteuse de texte ou apportant du sens) selon votre contexte --&gt;
    &lt;/div&gt;
...
&lt;/figure&gt;
                    ...
                    <div class="fr-mb-6v">
                        <figure role="group" class="fr-content-media fr-content-media--lg" id="media-1578" aria-label="Description / Source">
                            <div class="fr-content-media__img">
                                <img class="fr-responsive-img fr-ratio-16x9" src="../../../example/img/placeholder.16x9.png" alt="[À MODIFIER - vide ou texte alternatif de l’image]" />
                                <!-- L’alternative de l’image (attribut alt) doit toujours être présente, sa valeur peut-être vide (image n’apportant pas de sens supplémentaire au contexte) ou non (porteuse de texte ou apportant du sens) selon votre contexte -->
                            </div>
                            <figcaption class="fr-content-media__caption">
                                Description / Source
                                <a id="link-1579" href="#" class="fr-link">Libellé lien</a>
                            </figcaption>
                        </figure>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            ...
                            <div class="fr-collapse" id="snippet-1582">
                                <pre class=" language-html"><code>&lt;figure role="group" class="fr-content-media fr-content-media--lg" id="media-1580" aria-label="Description / Source"&gt;
    &lt;div class="fr-content-media__img"&gt;
        &lt;img class="fr-responsive-img fr-ratio-16x9" src="../../../example/img/placeholder.16x9.png" alt="[À MODIFIER - vide ou texte alternatif de l’image]" /&gt;
        &lt;!-- L’alternative de l’image (attribut alt) doit toujours être présente, sa valeur peut-être vide (image n’apportant pas de sens supplémentaire au contexte) ou non (porteuse de texte ou apportant du sens) selon votre contexte --&gt;
    &lt;/div&gt;
...
&lt;/figure&gt;
                    ...
                    <div class="fr-mb-6v">
                        <figure role="group" class="fr-content-media" id="media-1583" aria-label="Description / Source">
                            <div class="fr-content-media__img">
                            ...
                            <figcaption class="fr-content-media__caption">
                                Description / Source
                                <a id="link-1584" href="#" class="fr-link">Libellé lien</a>
                            </figcaption>
                        </figure>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1587">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1587">
                                <pre class=" language-html"><code>&lt;figure role="group" class="fr-content-media" id="media-1585" aria-label="Description / Source"&gt;
    &lt;div class="fr-content-media__img"&gt;
        &lt;img class="fr-responsive-img fr-ratio-32x9" src="../../../example/img/placeholder.16x9.png" alt="[À MODIFIER - vide ou texte alternatif de l’image]" /&gt;
        &lt;!-- L’alternative de l’image (attribut alt) doit toujours être présente, sa valeur peut-être vide (image n’apportant pas de sens supplémentaire au contexte) ou non (porteuse de texte ou apportant du sens) selon votre contexte --&gt;
    &lt;/div&gt;
...
&lt;/figure&gt;
                    ...
                    <div class="fr-mb-6v">
                        <figure role="group" class="fr-content-media" id="media-1588" aria-label="Description / Source">
                            <div class="fr-content-media__img">
                                <img class="fr-responsive-img fr-ratio-16x9" src="../../../example/img/placeholder.16x9.png" alt="[À MODIFIER - vide ou texte alternatif de l’image]" />
                                <!-- L’alternative de l’image (attribut alt) doit toujours être présente, sa valeur peut-être vide (image n’apportant pas de sens supplémentaire au contexte) ou non (porteuse de texte ou apportant du sens) selon votre contexte -->
                            </div>
                            <figcaption class="fr-content-media__caption">
                                Description / Source
                                <a id="link-1589" href="#" class="fr-link">Libellé lien</a>
                            </figcaption>
                        </figure>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1592">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1592">
                                <pre class=" language-html"><code>&lt;figure role="group" class="fr-content-media" id="media-1590" aria-label="Description / Source"&gt;
    &lt;div class="fr-content-media__img"&gt;
        &lt;img class="fr-responsive-img fr-ratio-16x9" src="../../../example/img/placeholder.16x9.png" alt="[À MODIFIER - vide ou texte alternatif de l’image]" /&gt;
        &lt;!-- L’alternative de l’image (attribut alt) doit toujours être présente, sa valeur peut-être vide (image n’apportant pas de sens supplémentaire au contexte) ou non (porteuse de texte ou apportant du sens) selon votre contexte --&gt;
    &lt;/div&gt;
...
&lt;/figure&gt;
                    ...
                    <div class="fr-mb-6v">
                        <figure role="group" class="fr-content-media" id="media-1593" aria-label="Description / Source">
                            <div class="fr-content-media__img">
                            ...
                            <figcaption class="fr-content-media__caption">
                                Description / Source
                                <a id="link-1594" href="#" class="fr-link">Libellé lien</a>
                            </figcaption>
                        </figure>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            ...
                            <div class="fr-collapse" id="snippet-1597">
                                <pre class=" language-html"><code>&lt;figure role="group" class="fr-content-media" id="media-1595" aria-label="Description / Source"&gt;
    &lt;div class="fr-content-media__img"&gt;
        &lt;img class="fr-responsive-img fr-ratio-3x2" src="../../../example/img/placeholder.16x9.png" alt="[À MODIFIER - vide ou texte alternatif de l’image]" /&gt;
        &lt;!-- L’alternative de l’image (attribut alt) doit toujours être présente, sa valeur peut-être vide (image n’apportant pas de sens supplémentaire au contexte) ou non (porteuse de texte ou apportant du sens) selon votre contexte --&gt;
    &lt;/div&gt;
...
&lt;/figure&gt;
                    ...
                    <div class="fr-mb-6v">
                        <figure role="group" class="fr-content-media" id="media-1598" aria-label="Description / Source">
                            <div class="fr-content-media__img">
                            ...
                            <figcaption class="fr-content-media__caption">
                                Description / Source
                                <a id="link-1599" href="#" class="fr-link">Libellé lien</a>
                            </figcaption>
                        </figure>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1602">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1602">
                                <pre class=" language-html"><code>&lt;figure role="group" class="fr-content-media" id="media-1600" aria-label="Description / Source"&gt;
    &lt;div class="fr-content-media__img"&gt;
        &lt;img class="fr-responsive-img fr-ratio-4x3" src="../../../example/img/placeholder.16x9.png" alt="[À MODIFIER - vide ou texte alternatif de l’image]" /&gt;
        &lt;!-- L’alternative de l’image (attribut alt) doit toujours être présente, sa valeur peut-être vide (image n’apportant pas de sens supplémentaire au contexte) ou non (porteuse de texte ou apportant du sens) selon votre contexte --&gt;
    &lt;/div&gt;
...
&lt;/figure&gt;
                    ...
                    <div class="fr-mb-6v">
                        <figure role="group" class="fr-content-media" id="media-1603" aria-label="Description / Source">
                            <div class="fr-content-media__img">
                            ...
                            <figcaption class="fr-content-media__caption">
                                Description / Source
                                <a id="link-1604" href="#" class="fr-link">Libellé lien</a>
                            </figcaption>
                        </figure>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1607">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1607">
                                <pre class=" language-html"><code>&lt;figure role="group" class="fr-content-media" id="media-1605" aria-label="Description / Source"&gt;
    &lt;div class="fr-content-media__img"&gt;
        &lt;img class="fr-responsive-img fr-ratio-1x1" src="../../../example/img/placeholder.16x9.png" alt="[À MODIFIER - vide ou texte alternatif de l’image]" /&gt;
        &lt;!-- L’alternative de l’image (attribut alt) doit toujours être présente, sa valeur peut-être vide (image n’apportant pas de sens supplémentaire au contexte) ou non (porteuse de texte ou apportant du sens) selon votre contexte --&gt;
    &lt;/div&gt;
...
&lt;/figure&gt;
                    ...
                    <div class="fr-mb-6v">
                        <figure role="group" class="fr-content-media" id="media-1608" aria-label="Description / Source">
                            <div class="fr-content-media__img">
                            ...
                            <figcaption class="fr-content-media__caption">
                                Description / Source
                                <a id="link-1609" href="#" class="fr-link">Libellé lien</a>
                            </figcaption>
                        </figure>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1612">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1612">
                                <pre class=" language-html"><code>&lt;figure role="group" class="fr-content-media" id="media-1610" aria-label="Description / Source"&gt;
    &lt;div class="fr-content-media__img"&gt;
        &lt;img class="fr-responsive-img fr-ratio-3x4" src="../../../example/img/placeholder.16x9.png" alt="[À MODIFIER - vide ou texte alternatif de l’image]" /&gt;
        &lt;!-- L’alternative de l’image (attribut alt) doit toujours être présente, sa valeur peut-être vide (image n’apportant pas de sens supplémentaire au contexte) ou non (porteuse de texte ou apportant du sens) selon votre contexte --&gt;
    &lt;/div&gt;
...
&lt;/figure&gt;
                    ...
                    <div class="fr-mb-6v">
                        <figure role="group" class="fr-content-media" id="media-1613" aria-label="Description / Source">
                            <div class="fr-content-media__img">
                            ...
                            <figcaption class="fr-content-media__caption">
                                Description / Source
                                <a id="link-1614" href="#" class="fr-link">Libellé lien</a>
                            </figcaption>
                        </figure>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            ...
                            <div class="fr-collapse" id="snippet-1617">
                                <pre class=" language-html"><code>&lt;figure role="group" class="fr-content-media" id="media-1615" aria-label="Description / Source"&gt;
    &lt;div class="fr-content-media__img"&gt;
        &lt;img class="fr-responsive-img fr-ratio-2x3" src="../../../example/img/placeholder.16x9.png" alt="[À MODIFIER - vide ou texte alternatif de l’image]" /&gt;
        &lt;!-- L’alternative de l’image (attribut alt) doit toujours être présente, sa valeur peut-être vide (image n’apportant pas de sens supplémentaire au contexte) ou non (porteuse de texte ou apportant du sens) selon votre contexte --&gt;
    &lt;/div&gt;
...
&lt;/figure&gt;
                    ...
                    <div class="fr-mb-6v">
                        <figure role="group" class="fr-content-media" id="media-1618" aria-label="Description / Source">
                            <div class="fr-content-media__img">
			...
			c3-8.1,4.2-8.8,11.5-10.1L44.5,272.3z" />
                            ...
                            <figcaption class="fr-content-media__caption">
                                Description / Source
                                <a id="link-1620" href="#" class="fr-link">Libellé lien</a>
                            </figcaption>
                        </figure>
                        <div class="fr-transcription" id="transcription-1619">
                            <button type="button" class="fr-transcription__btn" aria-expanded="false" aria-controls="fr-transcription-collapse-transcription-1619">Transcription</button>
                            <div class="fr-collapse" id="fr-transcription-collapse-transcription-1619">
                                <div class="fr-transcription__footer">
                                    <div class="fr-transcription__actions-group">
                                        <button aria-controls="fr-transcription-modal-transcription-1619" aria-label="Agrandir la transcription" data-fr-opened="false" type="button" class="fr-btn--fullscreen fr-btn">Agrandir</button>
                                    </div>
                                </div>
                                <dialog id="fr-transcription-modal-transcription-1619" class="fr-modal" aria-labelledby="fr-transcription-modal-transcription-1619-title">
                                    <div class="fr-container fr-container--fluid fr-container-md">
                                        <div class="fr-grid-row fr-grid-row--center">
                                            <div class="fr-col-12 fr-col-md-10 fr-col-lg-8">
                                                <div class="fr-modal__body">
                                                    <div class="fr-modal__header">
                                                        <button aria-controls="fr-transcription-modal-transcription-1619" title="Fermer" type="button" id="button-1622" class="fr-btn--close fr-btn">Fermer</button>
                                                    </div>
                                                    <div class="fr-modal__content">
                                                        <h2 id="fr-transcription-modal-transcription-1619-title" class="fr-modal__title">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1628">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1628">
                                <pre class=" language-html"><code>&lt;figure role="group" class="fr-content-media" id="media-1623" aria-label="Description / Source"&gt;
    &lt;div class="fr-content-media__img"&gt;
        &lt;!-- Les SVG porteurs de sens doivent avoir l'attribut role="img" et être labeliser par l'attribut aria-label="[A modifier - titre ou texte contenu dans l’image]" --&gt;
        &lt;svg version="1.1" role="img" aria-label=”Gouvernement” xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 895 455" xml:space="preserve"&gt;
            &lt;style type="text/css"&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <figure role="group" class="fr-content-media" id="media-1629" aria-label="Description / Source">
                            <div class="fr-content-media__img">
                            ...
                            <figcaption class="fr-content-media__caption">
                                Description / Source
                                <a id="link-1630" href="#" class="fr-link">Libellé lien</a>
                            </figcaption>
                        </figure>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            ...
                            <div class="fr-collapse" id="snippet-1633">
                                <pre class=" language-html"><code>&lt;figure role="group" class="fr-content-media" id="media-1631" aria-label="Description / Source"&gt;
    &lt;div class="fr-content-media__img"&gt;
        &lt;!-- Les SVG illustratifs (non porteur de sens) doivent avoir l'attribut aria-hidden="true" --&gt;
        &lt;svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 360 360"&gt;
            &lt;rect width="360" height="360" fill="#f2f2f9" /&gt;
...
&lt;/figure&gt;
                    ...
                    <div class="fr-mb-6v">
                        <figure role="group" class="fr-content-media" id="media-1634" aria-label="© DILA 2020">
                            <div class="fr-content-media__img">
                            ...
                            <figcaption class="fr-content-media__caption">
                                © DILA 2020
                                <a id="link-1636" href="#" class="fr-link">vie-publique.fr</a>
                            </figcaption>
                        </figure>
                        <div class="fr-transcription" id="transcription-1635">
                            <button type="button" class="fr-transcription__btn" aria-expanded="false" aria-controls="fr-transcription-collapse-transcription-1635">Transcription</button>
                            <div class="fr-collapse" id="fr-transcription-collapse-transcription-1635">
                                <div class="fr-transcription__footer">
                                    <div class="fr-transcription__actions-group">
                                        <button aria-controls="fr-transcription-modal-transcription-1635" aria-label="Agrandir la transcription" data-fr-opened="false" type="button" class="fr-btn--fullscreen fr-btn">Agrandir</button>
                                    </div>
                                </div>
                                <dialog id="fr-transcription-modal-transcription-1635" class="fr-modal" aria-labelledby="fr-transcription-modal-transcription-1635-title">
                                    <div class="fr-container fr-container--fluid fr-container-md">
                                        <div class="fr-grid-row fr-grid-row--center">
                                            <div class="fr-col-12 fr-col-md-10 fr-col-lg-8">
                                                <div class="fr-modal__body">
                                                    <div class="fr-modal__header">
                                                        <button aria-controls="fr-transcription-modal-transcription-1635" title="Fermer" type="button" id="button-1638" class="fr-btn--close fr-btn">Fermer</button>
                                                    </div>
                                                    <div class="fr-modal__content">
                                                        <h2 id="fr-transcription-modal-transcription-1635-title" class="fr-modal__title">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1644">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1644">
                                <pre class=" language-html"><code>&lt;figure role="group" class="fr-content-media" id="media-1639" aria-label="© DILA 2020"&gt;
    &lt;div class="fr-content-media__img"&gt;
        &lt;img class="fr-responsive-img fr-ratio-2x3" src="../../../example/img/placeholder-transcription.jpg" alt="Planche 1 de la BD Simone Veil : la loi sur l’avortement. Épisode 2 - voir transcription ci-dessous" /&gt;
        &lt;!-- L’alternative de l’image (attribut alt) doit toujours être présente, sa valeur peut-être vide (image n’apportant pas de sens supplémentaire au contexte) ou non (porteuse de texte ou apportant du sens) selon votre contexte --&gt;
    &lt;/div&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <figure role="group" class="fr-content-media" id="media-1645">
                            ...
                            <figcaption class="fr-content-media__caption">
                                Description / Source
                                <a id="link-1647" href="#" class="fr-link">Libellé lien</a>
                            </figcaption>
                        </figure>
                        <div class="fr-transcription" id="transcription-1646">
                            <button type="button" class="fr-transcription__btn" aria-expanded="false" aria-controls="fr-transcription-collapse-transcription-1646">Transcription</button>
                            <div class="fr-collapse" id="fr-transcription-collapse-transcription-1646">
                                <div class="fr-transcription__footer">
                                    <div class="fr-transcription__actions-group">
                                        <button aria-controls="fr-transcription-modal-transcription-1646" aria-label="Agrandir la transcription" data-fr-opened="false" type="button" class="fr-btn--fullscreen fr-btn">Agrandir</button>
                                    </div>
                                </div>
                                <dialog id="fr-transcription-modal-transcription-1646" class="fr-modal" aria-labelledby="fr-transcription-modal-transcription-1646-title">
                                    <div class="fr-container fr-container--fluid fr-container-md">
                                        <div class="fr-grid-row fr-grid-row--center">
                                            <div class="fr-col-12 fr-col-md-10 fr-col-lg-8">
                                                <div class="fr-modal__body">
                                                    <div class="fr-modal__header">
                                                        <button aria-controls="fr-transcription-modal-transcription-1646" title="Fermer" type="button" id="button-1649" class="fr-btn--close fr-btn">Fermer</button>
                                                    </div>
                                                    <div class="fr-modal__content">
                                                        <h2 id="fr-transcription-modal-transcription-1646-title" class="fr-modal__title">
                                                            Titre de la transcription
                                                        </h2>
                                                        <!-- données de test -->
                                                        <div>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1655">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1655">
                                <pre class=" language-html"><code>&lt;figure role="group" class="fr-content-media" id="media-1650"&gt;
    &lt;iframe title="Vidéo de présentation du Service National Universel - voir transcription ci-dessous" class="fr-responsive-vid" src="https://www.youtube.com/embed/HyirpmPL43I" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen&gt;&lt;/iframe&gt;
    &lt;figcaption class="fr-content-media__caption"&gt;
        Description / Source
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <figure role="group" class="fr-content-media fr-content-media--sm" id="media-1656">
                            <iframe title="Vidéo de présentation du Service National Universel - voir transcription ci-dessous" class="fr-responsive-vid" src="https://www.youtube.com/embed/HyirpmPL43I" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            <figcaption class="fr-content-media__caption">
                                Description / Source
                                <a id="link-1658" href="#" class="fr-link">Libellé lien</a>
                            </figcaption>
                        </figure>
                        <div class="fr-transcription" id="transcription-1657">
                            <button type="button" class="fr-transcription__btn" aria-expanded="false" aria-controls="fr-transcription-collapse-transcription-1657">Transcription</button>
                            <div class="fr-collapse" id="fr-transcription-collapse-transcription-1657">
                                <div class="fr-transcription__footer">
                                    <div class="fr-transcription__actions-group">
                                        <button aria-controls="fr-transcription-modal-transcription-1657" aria-label="Agrandir la transcription" data-fr-opened="false" type="button" class="fr-btn--fullscreen fr-btn">Agrandir</button>
                                    </div>
                                </div>
                                <dialog id="fr-transcription-modal-transcription-1657" class="fr-modal" aria-labelledby="fr-transcription-modal-transcription-1657-title">
                                    <div class="fr-container fr-container--fluid fr-container-md">
                                        <div class="fr-grid-row fr-grid-row--center">
                                            <div class="fr-col-12 fr-col-md-10 fr-col-lg-8">
                                                <div class="fr-modal__body">
                                                    <div class="fr-modal__header">
                                                        <button aria-controls="fr-transcription-modal-transcription-1657" title="Fermer" type="button" id="button-1660" class="fr-btn--close fr-btn">Fermer</button>
                                                    </div>
                                                    <div class="fr-modal__content">
                                                        <h2 id="fr-transcription-modal-transcription-1657-title" class="fr-modal__title">
                                                            Titre de la transcription
                                                        </h2>
                                                        <!-- données de test -->
                                                        <div>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            ...
                            <div class="fr-collapse" id="snippet-1666">
                                <pre class=" language-html"><code>&lt;figure role="group" class="fr-content-media fr-content-media--sm" id="media-1661"&gt;
    &lt;iframe title="Vidéo de présentation du Service National Universel - voir transcription ci-dessous" class="fr-responsive-vid" src="https://www.youtube.com/embed/HyirpmPL43I" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen&gt;&lt;/iframe&gt;
    &lt;figcaption class="fr-content-media__caption"&gt;
        Description / Source
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <figure role="group" class="fr-content-media fr-content-media--lg" id="media-1667">
                            <iframe title="Vidéo de présentation du Service National Universel - voir transcription ci-dessous" class="fr-responsive-vid" src="https://www.youtube.com/embed/HyirpmPL43I" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            <figcaption class="fr-content-media__caption">
                                Description / Source
                                <a id="link-1669" href="#" class="fr-link">Libellé lien</a>
                            </figcaption>
                        </figure>
                        <div class="fr-transcription" id="transcription-1668">
                            <button type="button" class="fr-transcription__btn" aria-expanded="false" aria-controls="fr-transcription-collapse-transcription-1668">Transcription</button>
                            <div class="fr-collapse" id="fr-transcription-collapse-transcription-1668">
                                <div class="fr-transcription__footer">
                                    <div class="fr-transcription__actions-group">
                                        <button aria-controls="fr-transcription-modal-transcription-1668" aria-label="Agrandir la transcription" data-fr-opened="false" type="button" class="fr-btn--fullscreen fr-btn">Agrandir</button>
                                    </div>
                                </div>
                                <dialog id="fr-transcription-modal-transcription-1668" class="fr-modal" aria-labelledby="fr-transcription-modal-transcription-1668-title">
                                    <div class="fr-container fr-container--fluid fr-container-md">
                                        <div class="fr-grid-row fr-grid-row--center">
                                            <div class="fr-col-12 fr-col-md-10 fr-col-lg-8">
                                                <div class="fr-modal__body">
                                                    <div class="fr-modal__header">
                                                        <button aria-controls="fr-transcription-modal-transcription-1668" title="Fermer" type="button" id="button-1671" class="fr-btn--close fr-btn">Fermer</button>
                                                    </div>
                                                    <div class="fr-modal__content">
                                                        <h2 id="fr-transcription-modal-transcription-1668-title" class="fr-modal__title">
                                                            Titre de la transcription
                                                        </h2>
                                                        <!-- données de test -->
                                                        <div>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1677">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1677">
                                <pre class=" language-html"><code>&lt;figure role="group" class="fr-content-media fr-content-media--lg" id="media-1672"&gt;
    &lt;iframe title="Vidéo de présentation du Service National Universel - voir transcription ci-dessous" class="fr-responsive-vid" src="https://www.youtube.com/embed/HyirpmPL43I" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen&gt;&lt;/iframe&gt;
    &lt;figcaption class="fr-content-media__caption"&gt;
        Description / Source
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <figure role="group" class="fr-content-media" id="media-1678">
                            ...
                            <figcaption class="fr-content-media__caption">
                                Description / Source
                                <a id="link-1680" href="#" class="fr-link">Libellé lien</a>
                            </figcaption>
                        </figure>
                        <div class="fr-transcription" id="transcription-1679">
                            <button type="button" class="fr-transcription__btn" aria-expanded="false" aria-controls="fr-transcription-collapse-transcription-1679">Transcription</button>
                            <div class="fr-collapse" id="fr-transcription-collapse-transcription-1679">
                                <div class="fr-transcription__footer">
                                    <div class="fr-transcription__actions-group">
                                        <button aria-controls="fr-transcription-modal-transcription-1679" aria-label="Agrandir la transcription" data-fr-opened="false" type="button" class="fr-btn--fullscreen fr-btn">Agrandir</button>
                                    </div>
                                </div>
                                <dialog id="fr-transcription-modal-transcription-1679" class="fr-modal" aria-labelledby="fr-transcription-modal-transcription-1679-title">
                                    <div class="fr-container fr-container--fluid fr-container-md">
                                        <div class="fr-grid-row fr-grid-row--center">
                                            <div class="fr-col-12 fr-col-md-10 fr-col-lg-8">
                                                <div class="fr-modal__body">
                                                    <div class="fr-modal__header">
                                                        <button aria-controls="fr-transcription-modal-transcription-1679" title="Fermer" type="button" id="button-1682" class="fr-btn--close fr-btn">Fermer</button>
                                                    </div>
                                                    <div class="fr-modal__content">
                                                        <h2 id="fr-transcription-modal-transcription-1679-title" class="fr-modal__title">
                                                            Titre de la transcription
                                                        </h2>
                                                        <!-- données de test -->
                                                        <div>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1688">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1688">
                                <pre class=" language-html"><code>&lt;figure role="group" class="fr-content-media" id="media-1683"&gt;
    &lt;iframe title="Vidéo de présentation du Service National Universel - voir transcription ci-dessous" class="fr-responsive-vid fr-ratio-4x3" src="https://www.youtube.com/embed/HyirpmPL43I" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen&gt;&lt;/iframe&gt;
    &lt;figcaption class="fr-content-media__caption"&gt;
        Description / Source
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <figure role="group" class="fr-content-media fr-content-media--sm" id="media-1689">
                            <iframe title="Vidéo de présentation du Service National Universel - voir transcription ci-dessous" class="fr-responsive-vid fr-ratio-4x3" src="https://www.youtube.com/embed/HyirpmPL43I" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            <figcaption class="fr-content-media__caption">
                                Description / Source
                                <a id="link-1691" href="#" class="fr-link">Libellé lien</a>
                            </figcaption>
                        </figure>
                        <div class="fr-transcription" id="transcription-1690">
                            <button type="button" class="fr-transcription__btn" aria-expanded="false" aria-controls="fr-transcription-collapse-transcription-1690">Transcription</button>
                            <div class="fr-collapse" id="fr-transcription-collapse-transcription-1690">
                                <div class="fr-transcription__footer">
                                    <div class="fr-transcription__actions-group">
                                        <button aria-controls="fr-transcription-modal-transcription-1690" aria-label="Agrandir la transcription" data-fr-opened="false" type="button" class="fr-btn--fullscreen fr-btn">Agrandir</button>
                                    </div>
                                </div>
                                <dialog id="fr-transcription-modal-transcription-1690" class="fr-modal" aria-labelledby="fr-transcription-modal-transcription-1690-title">
                                    <div class="fr-container fr-container--fluid fr-container-md">
                                        <div class="fr-grid-row fr-grid-row--center">
                                            <div class="fr-col-12 fr-col-md-10 fr-col-lg-8">
                                                <div class="fr-modal__body">
                                                    <div class="fr-modal__header">
                                                        <button aria-controls="fr-transcription-modal-transcription-1690" title="Fermer" type="button" id="button-1693" class="fr-btn--close fr-btn">Fermer</button>
                                                    </div>
                                                    <div class="fr-modal__content">
                                                        <h2 id="fr-transcription-modal-transcription-1690-title" class="fr-modal__title">
                                                            Titre de la transcription
                                                        </h2>
                                                        <!-- données de test -->
                                                        <div>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            ...
                            <div class="fr-collapse" id="snippet-1699">
                                <pre class=" language-html"><code>&lt;figure role="group" class="fr-content-media fr-content-media--sm" id="media-1694"&gt;
    &lt;iframe title="Vidéo de présentation du Service National Universel - voir transcription ci-dessous" class="fr-responsive-vid fr-ratio-4x3" src="https://www.youtube.com/embed/HyirpmPL43I" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen&gt;&lt;/iframe&gt;
    &lt;figcaption class="fr-content-media__caption"&gt;
        Description / Source
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <figure role="group" class="fr-content-media fr-content-media--lg" id="media-1700">
                            <iframe title="Vidéo de présentation du Service National Universel - voir transcription ci-dessous" class="fr-responsive-vid fr-ratio-4x3" src="https://www.youtube.com/embed/HyirpmPL43I" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            <figcaption class="fr-content-media__caption">
                                Description / Source
                                <a id="link-1702" href="#" class="fr-link">Libellé lien</a>
                            </figcaption>
                        </figure>
                        <div class="fr-transcription" id="transcription-1701">
                            <button type="button" class="fr-transcription__btn" aria-expanded="false" aria-controls="fr-transcription-collapse-transcription-1701">Transcription</button>
                            <div class="fr-collapse" id="fr-transcription-collapse-transcription-1701">
                                <div class="fr-transcription__footer">
                                    <div class="fr-transcription__actions-group">
                                        <button aria-controls="fr-transcription-modal-transcription-1701" aria-label="Agrandir la transcription" data-fr-opened="false" type="button" class="fr-btn--fullscreen fr-btn">Agrandir</button>
                                    </div>
                                </div>
                                <dialog id="fr-transcription-modal-transcription-1701" class="fr-modal" aria-labelledby="fr-transcription-modal-transcription-1701-title">
                                    <div class="fr-container fr-container--fluid fr-container-md">
                                        <div class="fr-grid-row fr-grid-row--center">
                                            <div class="fr-col-12 fr-col-md-10 fr-col-lg-8">
                                                <div class="fr-modal__body">
                                                    <div class="fr-modal__header">
                                                        <button aria-controls="fr-transcription-modal-transcription-1701" title="Fermer" type="button" id="button-1704" class="fr-btn--close fr-btn">Fermer</button>
                                                    </div>
                                                    <div class="fr-modal__content">
                                                        <h2 id="fr-transcription-modal-transcription-1701-title" class="fr-modal__title">
                                                            Titre de la transcription
                                                        </h2>
                                                        <!-- données de test -->
                                                        <div>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1710">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1710">
                                <pre class=" language-html"><code>&lt;figure role="group" class="fr-content-media fr-content-media--lg" id="media-1705"&gt;
    &lt;iframe title="Vidéo de présentation du Service National Universel - voir transcription ci-dessous" class="fr-responsive-vid fr-ratio-4x3" src="https://www.youtube.com/embed/HyirpmPL43I" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen&gt;&lt;/iframe&gt;
    &lt;figcaption class="fr-content-media__caption"&gt;
        Description / Source
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <figure role="group" class="fr-content-media" id="media-1711">
                            ...
                            <figcaption class="fr-content-media__caption">
                                Description / Source
                                <a id="link-1713" href="#" class="fr-link">Libellé lien</a>
                            </figcaption>
                        </figure>
                        <div class="fr-transcription" id="transcription-1712">
                            <button type="button" class="fr-transcription__btn" aria-expanded="false" aria-controls="fr-transcription-collapse-transcription-1712">Transcription</button>
                            <div class="fr-collapse" id="fr-transcription-collapse-transcription-1712">
                                <div class="fr-transcription__footer">
                                    <div class="fr-transcription__actions-group">
                                        <button aria-controls="fr-transcription-modal-transcription-1712" aria-label="Agrandir la transcription" data-fr-opened="false" type="button" class="fr-btn--fullscreen fr-btn">Agrandir</button>
                                    </div>
                                </div>
                                <dialog id="fr-transcription-modal-transcription-1712" class="fr-modal" aria-labelledby="fr-transcription-modal-transcription-1712-title">
                                    <div class="fr-container fr-container--fluid fr-container-md">
                                        <div class="fr-grid-row fr-grid-row--center">
                                            <div class="fr-col-12 fr-col-md-10 fr-col-lg-8">
                                                <div class="fr-modal__body">
                                                    <div class="fr-modal__header">
                                                        <button aria-controls="fr-transcription-modal-transcription-1712" title="Fermer" type="button" id="button-1715" class="fr-btn--close fr-btn">Fermer</button>
                                                    </div>
                                                    <div class="fr-modal__content">
                                                        <h2 id="fr-transcription-modal-transcription-1712-title" class="fr-modal__title">
                                                            Titre de la transcription
                                                        </h2>
                                                        <!-- données de test -->
                                                        <div>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1721">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1721">
                                <pre class=" language-html"><code>&lt;figure role="group" class="fr-content-media" id="media-1716"&gt;
    &lt;iframe title="Vidéo de présentation du Service National Universel - voir transcription ci-dessous" class="fr-responsive-vid fr-ratio-1x1" src="https://www.youtube.com/embed/HyirpmPL43I" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen&gt;&lt;/iframe&gt;
    &lt;figcaption class="fr-content-media__caption"&gt;
        Description / Source
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <figure role="group" class="fr-content-media fr-content-media--sm" id="media-1722">
                            <iframe title="Vidéo de présentation du Service National Universel - voir transcription ci-dessous" class="fr-responsive-vid fr-ratio-1x1" src="https://www.youtube.com/embed/HyirpmPL43I" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            <figcaption class="fr-content-media__caption">
                                Description / Source
                                <a id="link-1724" href="#" class="fr-link">Libellé lien</a>
                            </figcaption>
                        </figure>
                        <div class="fr-transcription" id="transcription-1723">
                            <button type="button" class="fr-transcription__btn" aria-expanded="false" aria-controls="fr-transcription-collapse-transcription-1723">Transcription</button>
                            <div class="fr-collapse" id="fr-transcription-collapse-transcription-1723">
                                <div class="fr-transcription__footer">
                                    <div class="fr-transcription__actions-group">
                                        <button aria-controls="fr-transcription-modal-transcription-1723" aria-label="Agrandir la transcription" data-fr-opened="false" type="button" class="fr-btn--fullscreen fr-btn">Agrandir</button>
                                    </div>
                                </div>
                                <dialog id="fr-transcription-modal-transcription-1723" class="fr-modal" aria-labelledby="fr-transcription-modal-transcription-1723-title">
                                    <div class="fr-container fr-container--fluid fr-container-md">
                                        <div class="fr-grid-row fr-grid-row--center">
                                            <div class="fr-col-12 fr-col-md-10 fr-col-lg-8">
                                                <div class="fr-modal__body">
                                                    <div class="fr-modal__header">
                                                        <button aria-controls="fr-transcription-modal-transcription-1723" title="Fermer" type="button" id="button-1726" class="fr-btn--close fr-btn">Fermer</button>
                                                    </div>
                                                    <div class="fr-modal__content">
                                                        <h2 id="fr-transcription-modal-transcription-1723-title" class="fr-modal__title">
                                                            Titre de la transcription
                                                        </h2>
                                                        <!-- données de test -->
                                                        <div>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1732">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1732">
                                <pre class=" language-html"><code>&lt;figure role="group" class="fr-content-media fr-content-media--sm" id="media-1727"&gt;
    &lt;iframe title="Vidéo de présentation du Service National Universel - voir transcription ci-dessous" class="fr-responsive-vid fr-ratio-1x1" src="https://www.youtube.com/embed/HyirpmPL43I" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen&gt;&lt;/iframe&gt;
    &lt;figcaption class="fr-content-media__caption"&gt;
        Description / Source
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <figure role="group" class="fr-content-media fr-content-media--lg" id="media-1733">
                            <iframe title="Vidéo de présentation du Service National Universel - voir transcription ci-dessous" class="fr-responsive-vid fr-ratio-1x1" src="https://www.youtube.com/embed/HyirpmPL43I" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            <figcaption class="fr-content-media__caption">
                                Description / Source
                                <a id="link-1735" href="#" class="fr-link">Libellé lien</a>
                            </figcaption>
                        </figure>
                        <div class="fr-transcription" id="transcription-1734">
                            <button type="button" class="fr-transcription__btn" aria-expanded="false" aria-controls="fr-transcription-collapse-transcription-1734">Transcription</button>
                            <div class="fr-collapse" id="fr-transcription-collapse-transcription-1734">
                                <div class="fr-transcription__footer">
                                    <div class="fr-transcription__actions-group">
                                        <button aria-controls="fr-transcription-modal-transcription-1734" aria-label="Agrandir la transcription" data-fr-opened="false" type="button" class="fr-btn--fullscreen fr-btn">Agrandir</button>
                                    </div>
                                </div>
                                <dialog id="fr-transcription-modal-transcription-1734" class="fr-modal" aria-labelledby="fr-transcription-modal-transcription-1734-title">
                                    <div class="fr-container fr-container--fluid fr-container-md">
                                        <div class="fr-grid-row fr-grid-row--center">
                                            <div class="fr-col-12 fr-col-md-10 fr-col-lg-8">
                                                <div class="fr-modal__body">
                                                    <div class="fr-modal__header">
                                                        <button aria-controls="fr-transcription-modal-transcription-1734" title="Fermer" type="button" id="button-1737" class="fr-btn--close fr-btn">Fermer</button>
                                                    </div>
                                                    <div class="fr-modal__content">
                                                        <h2 id="fr-transcription-modal-transcription-1734-title" class="fr-modal__title">
                                                            Titre de la transcription
                                                        </h2>
                                                        <!-- données de test -->
                                                        <div>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1743">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1743">
                                <pre class=" language-html"><code>&lt;figure role="group" class="fr-content-media fr-content-media--lg" id="media-1738"&gt;
    &lt;iframe title="Vidéo de présentation du Service National Universel - voir transcription ci-dessous" class="fr-responsive-vid fr-ratio-1x1" src="https://www.youtube.com/embed/HyirpmPL43I" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen&gt;&lt;/iframe&gt;
    &lt;figcaption class="fr-content-media__caption"&gt;
        Description / Source
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-content-media">
                            ...
                            <div class="fr-content-media__transcription">
                                <a id="link-1744" href="[url - à modifier]" class="fr-link">Libellé du bouton de la transcription</a>
                            </div>
                        </div>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1746">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1746">
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-content-media">
                            ...
                            <div class="fr-content-media__caption">© Légende de la vidéo</div>
                            <div class="fr-content-media__transcription">
                                <a id="link-1747" href="[url - à modifier]" class="fr-link">Libellé du bouton de la transcription</a>
                            </div>
                        </div>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1749">Extrait de code</button>
                            </h3>
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1750">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1750">
        ...
        <div class="fr-container fr-container--fluid fr-container-md">
            <div class="fr-grid-row fr-grid-row--center">
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button aria-controls="fr-theme-modal" title="Fermer" type="button" id="button-1751" class="fr-btn--close fr-btn">Fermer</button>
                        </div>
                        <div class="fr-modal__content">
