            ...
            <div class="fr-grid-row fr-grid-row--center">
                <div class="fr-col-md-8 fr-col-12">
                    ...
                    <div class="fr-mb-6v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-528">Libellé accordéon</button>
                            </h3>
                            <div class="fr-collapse" id="accordion-528">
                                <!-- données de test -->
                                <div>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-530">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-530">
...
&lt;/section&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-accordions-group">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-531">Libellé accordéon</button>
                                </h3>
                                <div class="fr-collapse" id="accordion-531">
                                    <!-- données de test -->
                                    <div>
                                        <h4 class="fr-h4">Contenu </h4>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing, <a href="https://www.systeme-de-design.gouv.fr/" target="_blank">link test</a> incididunt, ut labore et dolore magna aliqua. Vitae sapien pellentesque habitant morbi tristique senectus et. Diam maecenas sed enim ut. Accumsan lacus vel facilisis volutpat est. Ut aliquam purus sit amet luctus. Lorem ipsum dolor sit amet consectetur adipiscing elit ut.</p>
                            ...
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-532">Libellé accordéon</button>
                                </h3>
                                <div class="fr-collapse" id="accordion-532">
                                    <!-- données de test -->
                                    <div>
                                        <h4 class="fr-h4">Contenu </h4>
                            ...
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-533">Libellé accordéon</button>
                                </h3>
                                <div class="fr-collapse" id="accordion-533">
                                    <!-- données de test -->
                                    <div>
                                        <h4 class="fr-h4">Contenu </h4>
                                        <ul>
                            ...
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-534">Libellé accordéon</button>
                                </h3>
                                <div class="fr-collapse" id="accordion-534">
                                    <!-- données de test -->
                                    <div>
                                        <h4 class="fr-h4">Contenu </h4>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing, <a href="https://www.systeme-de-design.gouv.fr/" target="_blank">link test</a> incididunt, ut labore et dolore magna aliqua. Vitae sapien pellentesque habitant morbi tristique senectus et. Diam maecenas sed enim ut. Accumsan lacus vel facilisis volutpat est. Ut aliquam purus sit amet luctus. Lorem ipsum dolor sit amet consectetur adipiscing elit ut.</p>
                            ...
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-535">Libellé accordéon</button>
                                </h3>
                                <div class="fr-collapse" id="accordion-535">
                                    <!-- données de test -->
                                    <div>
                                        <h4 class="fr-h4">Contenu </h4>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing, <a href="https://www.systeme-de-design.gouv.fr/" target="_blank">link test</a> incididunt, ut labore et dolore magna aliqua. Vitae sapien pellentesque habitant morbi tristique senectus et. Diam maecenas sed enim ut. Accumsan lacus vel facilisis volutpat est. Ut aliquam purus sit amet luctus. Lorem ipsum dolor sit amet consectetur adipiscing elit ut.</p>
                            ...
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-536">Libellé accordéon</button>
                                </h3>
                                <div class="fr-collapse" id="accordion-536">
                                    <!-- données de test -->
                                    <div>
                                        <h4 class="fr-h4">Contenu </h4>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing, <a href="https://www.systeme-de-design.gouv.fr/" target="_blank">link test</a> incididunt, ut labore et dolore magna aliqua. Vitae sapien pellentesque habitant morbi tristique senectus et. Diam maecenas sed enim ut. Accumsan lacus vel facilisis volutpat est. Ut aliquam purus sit amet luctus. Lorem ipsum dolor sit amet consectetur adipiscing elit ut.</p>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-543">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-543">
...
&lt;/div&gt;
                    ...
                    <h3>Groupe d‘accordéons ouvert au chargement</h3>
                    <div class="fr-mb-6v">
                        <div class="fr-accordions-group">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="true" aria-controls="accordion-544">Libellé accordéon</button>
                                </h3>
                                <div class="fr-collapse fr-collapse--expanded" id="accordion-544">
                                    <!-- données de test -->
                                    <div>
                                        <h4 class="fr-h4">Contenu </h4>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing, <a href="https://www.systeme-de-design.gouv.fr/" target="_blank">link test</a> incididunt, ut labore et dolore magna aliqua. Vitae sapien pellentesque habitant morbi tristique senectus et. Diam maecenas sed enim ut. Accumsan lacus vel facilisis volutpat est. Ut aliquam purus sit amet luctus. Lorem ipsum dolor sit amet consectetur adipiscing elit ut.</p>
                            ...
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-545">Libellé accordéon</button>
                                </h3>
                                <div class="fr-collapse" id="accordion-545">
                                    <!-- données de test -->
                                    <div>
                                        <h4 class="fr-h4">Contenu </h4>
                                        <ul>
                            ...
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-546">Libellé accordéon</button>
                                </h3>
                                <div class="fr-collapse" id="accordion-546">
                                    <!-- données de test -->
                                    <div>
                                        <h4 class="fr-h4">Contenu </h4>
                                        <ul>
                            ...
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-547">Libellé accordéon</button>
                                </h3>
                                <div class="fr-collapse" id="accordion-547">
                                    <!-- données de test -->
                                    <div>
                                        <h4 class="fr-h4">Contenu </h4>
                                        <img class="fr-responsive-img" src="../../../example/img/placeholder.16x9.png" alt="" />
                            ...
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-548">Libellé accordéon</button>
                                </h3>
                                <div class="fr-collapse" id="accordion-548">
                                    <!-- données de test -->
                                    <div>
                                        <h4 class="fr-h4">Contenu </h4>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing, <a href="https://www.systeme-de-design.gouv.fr/" target="_blank">link test</a> incididunt, ut labore et dolore magna aliqua. Vitae sapien pellentesque habitant morbi tristique senectus et. Diam maecenas sed enim ut. Accumsan lacus vel facilisis volutpat est. Ut aliquam purus sit amet luctus. Lorem ipsum dolor sit amet consectetur adipiscing elit ut.</p>
                            ...
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-549">Libellé accordéon</button>
                                </h3>
                                <div class="fr-collapse" id="accordion-549">
                                    <!-- données de test -->
                                    <div>
                                        <h4 class="fr-h4">Contenu </h4>
                                        <ul>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-556">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-556">
                                <pre class=" language-html"><code>&lt;div class="fr-accordions-group"&gt;
    &lt;section class="fr-accordion"&gt;
        &lt;h3 class="fr-accordion__title"&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div data-fr-group="false" class="fr-accordions-group">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-557">Libellé accordéon</button>
                                </h3>
                                <div class="fr-collapse" id="accordion-557">
                                    <!-- données de test -->
                                    <div>
                                        <h4 class="fr-h4">Contenu </h4>
                                        <ul>
                            ...
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-558">Libellé accordéon</button>
                                </h3>
                                <div class="fr-collapse" id="accordion-558">
                                    <!-- données de test -->
                                    <div>
                                        <h4 class="fr-h4">Contenu </h4>
                                        <img class="fr-responsive-img" src="../../../example/img/placeholder.16x9.png" alt="" />
                            ...
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-559">Libellé accordéon</button>
                                </h3>
                                <div class="fr-collapse" id="accordion-559">
                                    <!-- données de test -->
                                    <div>
                                        <h4 class="fr-h4">Contenu </h4>
                                        <img class="fr-responsive-img" src="../../../example/img/placeholder.16x9.png" alt="" />
                            ...
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-560">Libellé accordéon</button>
                                </h3>
                                <div class="fr-collapse" id="accordion-560">
                                    <!-- données de test -->
                                    <div>
                                        <h4 class="fr-h4">Contenu </h4>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing, <a href="https://www.systeme-de-design.gouv.fr/" target="_blank">link test</a> incididunt, ut labore et dolore magna aliqua. Vitae sapien pellentesque habitant morbi tristique senectus et. Diam maecenas sed enim ut. Accumsan lacus vel facilisis volutpat est. Ut aliquam purus sit amet luctus. Lorem ipsum dolor sit amet consectetur adipiscing elit ut.</p>
                            ...
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-561">Libellé accordéon</button>
                                </h3>
                                <div class="fr-collapse" id="accordion-561">
                                    <!-- données de test -->
                                    <div>
                                        <h4 class="fr-h4">Contenu </h4>
                                        <img class="fr-responsive-img" src="../../../example/img/placeholder.16x9.png" alt="" />
                            ...
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-562">Libellé accordéon</button>
                                </h3>
                                <div class="fr-collapse" id="accordion-562">
                                    <!-- données de test -->
                                    <div>
                                        <h4 class="fr-h4">Contenu </h4>
                                        <ul>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-569">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-569">
...
&lt;/div&gt;
                    ...
                    <h3>Groupe d‘accordéons dissociés ouvert au chargement</h3>
                    <div class="fr-mb-6v">
                        <div data-fr-group="false" class="fr-accordions-group">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="true" aria-controls="accordion-570">Libellé accordéon</button>
                                </h3>
                                <div class="fr-collapse fr-collapse--expanded" id="accordion-570">
                                    <!-- données de test -->
                                    <div>
                                        <h4 class="fr-h4">Contenu </h4>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing, <a href="https://www.systeme-de-design.gouv.fr/" target="_blank">link test</a> incididunt, ut labore et dolore magna aliqua. Vitae sapien pellentesque habitant morbi tristique senectus et. Diam maecenas sed enim ut. Accumsan lacus vel facilisis volutpat est. Ut aliquam purus sit amet luctus. Lorem ipsum dolor sit amet consectetur adipiscing elit ut.</p>
                            ...
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="true" aria-controls="accordion-571">Libellé accordéon</button>
                                </h3>
                                <div class="fr-collapse fr-collapse--expanded" id="accordion-571">
                                    <!-- données de test -->
                                    <div>
                                        <h4 class="fr-h4">Contenu </h4>
                                        <img class="fr-responsive-img" src="../../../example/img/placeholder.16x9.png" alt="" />
                            ...
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="true" aria-controls="accordion-572">Libellé accordéon</button>
                                </h3>
                                <div class="fr-collapse fr-collapse--expanded" id="accordion-572">
                                    <!-- données de test -->
                                    <div>
                                        <h4 class="fr-h4">Contenu </h4>
                                        <img class="fr-responsive-img" src="../../../example/img/placeholder.16x9.png" alt="" />
                            ...
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="true" aria-controls="accordion-573">Libellé accordéon</button>
                                </h3>
                                <div class="fr-collapse fr-collapse--expanded" id="accordion-573">
                                    <!-- données de test -->
                                    <div>
                                        <h4 class="fr-h4">Contenu </h4>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing, <a href="https://www.systeme-de-design.gouv.fr/" target="_blank">link test</a> incididunt, ut labore et dolore magna aliqua. Vitae sapien pellentesque habitant morbi tristique senectus et. Diam maecenas sed enim ut. Accumsan lacus vel facilisis volutpat est. Ut aliquam purus sit amet luctus. Lorem ipsum dolor sit amet consectetur adipiscing elit ut.</p>
                            ...
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="true" aria-controls="accordion-574">Libellé accordéon</button>
                                </h3>
                                <div class="fr-collapse fr-collapse--expanded" id="accordion-574">
                                    <!-- données de test -->
                                    <div>
                                        <h4 class="fr-h4">Contenu </h4>
                                        <img class="fr-responsive-img" src="../../../example/img/placeholder.16x9.png" alt="" />
                            ...
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="true" aria-controls="accordion-575">Libellé accordéon</button>
                                </h3>
                                <div class="fr-collapse fr-collapse--expanded" id="accordion-575">
                                    <!-- données de test -->
                                    <div>
                                        <h4 class="fr-h4">Contenu </h4>
                                        <ul>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-582">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-582">
                                <pre class=" language-html"><code>&lt;div data-fr-group="false" class="fr-accordions-group"&gt;
    &lt;section class="fr-accordion"&gt;
        &lt;h3 class="fr-accordion__title"&gt;
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button aria-controls="fr-theme-modal" title="Fermer" type="button" id="button-583" class="fr-btn--close fr-btn">Fermer</button>
                        </div>
