...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <a href="https://www.systeme-de-design.gouv.fr/version-courante/fr/composants/accordeon" rel="noopener external" target="_blank" title="${getBlankTitle('Documentation')}">Documentation</a>
    </div>
    <div class="fr-mb-12w">
                ...
                <div class="fr-col-md-8 fr-col-12">
                    ...
                    <div class="fr-mb-6v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-584">Libellé accordéon</button>
                            </h3>
                            <div class="fr-collapse" id="accordion-584">
                                <section class="fr-accordion">
                                    <h3 class="fr-accordion__title">
                                        <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-585">Libellé accordéon</button>
                                    </h3>
                                    <div class="fr-collapse" id="accordion-585">
                                        <!-- données de test -->
                                        <div>
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-accordions-group">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-592">Libellé accordéon</button>
                                </h3>
                                <div class="fr-collapse" id="accordion-592">
                                    <div class="fr-accordions-group">
                                        <section class="fr-accordion">
                                            <h3 class="fr-accordion__title">
                                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-586">Libellé accordéon</button>
                                            </h3>
                                            <div class="fr-collapse" id="accordion-586">
                                                <!-- données de test -->
                                                <div>
                                                    <h4 class="fr-h4">Contenu </h4>
                                                    <img class="fr-responsive-img" src="../../../../example/img/placeholder.16x9.png" alt="" />
                                        ...
                                        <section class="fr-accordion">
                                            <h3 class="fr-accordion__title">
                                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-587">Libellé accordéon</button>
                                            </h3>
                                            <div class="fr-collapse" id="accordion-587">
                                                <!-- données de test -->
                                                <div>
                                                    <h4 class="fr-h4">Contenu </h4>
                                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing, <a href="https://www.systeme-de-design.gouv.fr/" target="_blank">link test</a> incididunt, ut labore et dolore magna aliqua. Vitae sapien pellentesque habitant morbi tristique senectus et. Diam maecenas sed enim ut. Accumsan lacus vel facilisis volutpat est. Ut aliquam purus sit amet luctus. Lorem ipsum dolor sit amet consectetur adipiscing elit ut.</p>
                                        ...
                                        <section class="fr-accordion">
                                            <h3 class="fr-accordion__title">
                                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-588">Libellé accordéon</button>
                                            </h3>
                                            <div class="fr-collapse" id="accordion-588">
                                                <!-- données de test -->
                                                <div>
                                                    <h4 class="fr-h4">Contenu </h4>
                                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing, <a href="https://www.systeme-de-design.gouv.fr/" target="_blank">link test</a> incididunt, ut labore et dolore magna aliqua. Vitae sapien pellentesque habitant morbi tristique senectus et. Diam maecenas sed enim ut. Accumsan lacus vel facilisis volutpat est. Ut aliquam purus sit amet luctus. Lorem ipsum dolor sit amet consectetur adipiscing elit ut.</p>
                                        ...
                                        <section class="fr-accordion">
                                            <h3 class="fr-accordion__title">
                                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-589">Libellé accordéon</button>
                                            </h3>
                                            <div class="fr-collapse" id="accordion-589">
                                                <!-- données de test -->
                                                <div>
                                                    <h4 class="fr-h4">Contenu </h4>
                                                    <img class="fr-responsive-img" src="../../../../example/img/placeholder.16x9.png" alt="" />
                                        ...
                                        <section class="fr-accordion">
                                            <h3 class="fr-accordion__title">
                                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-590">Libellé accordéon</button>
                                            </h3>
                                            <div class="fr-collapse" id="accordion-590">
                                                <!-- données de test -->
                                                <div>
                                                    <h4 class="fr-h4">Contenu </h4>
                                                    <img class="fr-responsive-img" src="../../../../example/img/placeholder.16x9.png" alt="" />
                                        ...
                                        <section class="fr-accordion">
                                            <h3 class="fr-accordion__title">
                                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-591">Libellé accordéon</button>
                                            </h3>
                                            <div class="fr-collapse" id="accordion-591">
                                                <!-- données de test -->
                                                <div>
                                                    <h4 class="fr-h4">Contenu </h4>
                                                    <ul>
                            ...
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-599">Libellé accordéon</button>
                                </h3>
                                <div class="fr-collapse" id="accordion-599">
                                    <div class="fr-accordions-group">
                                        <section class="fr-accordion">
                                            <h3 class="fr-accordion__title">
                                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-593">Libellé accordéon</button>
                                            </h3>
                                            <div class="fr-collapse" id="accordion-593">
                                                <!-- données de test -->
                                                <div>
                                                    <h4 class="fr-h4">Contenu </h4>
                                                    <img class="fr-responsive-img" src="../../../../example/img/placeholder.16x9.png" alt="" />
                                        ...
                                        <section class="fr-accordion">
                                            <h3 class="fr-accordion__title">
                                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-594">Libellé accordéon</button>
                                            </h3>
                                            <div class="fr-collapse" id="accordion-594">
                                                <!-- données de test -->
                                                <div>
                                                    <h4 class="fr-h4">Contenu </h4>
                                                    <ul>
                                        ...
                                        <section class="fr-accordion">
                                            <h3 class="fr-accordion__title">
                                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-595">Libellé accordéon</button>
                                            </h3>
                                            <div class="fr-collapse" id="accordion-595">
                                                <!-- données de test -->
                                                <div>
                                                    <h4 class="fr-h4">Contenu </h4>
                                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing, <a href="https://www.systeme-de-design.gouv.fr/" target="_blank">link test</a> incididunt, ut labore et dolore magna aliqua. Vitae sapien pellentesque habitant morbi tristique senectus et. Diam maecenas sed enim ut. Accumsan lacus vel facilisis volutpat est. Ut aliquam purus sit amet luctus. Lorem ipsum dolor sit amet consectetur adipiscing elit ut.</p>
                                        ...
                                        <section class="fr-accordion">
                                            <h3 class="fr-accordion__title">
                                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-596">Libellé accordéon</button>
                                            </h3>
                                        ...
                                        <section class="fr-accordion">
                                            <h3 class="fr-accordion__title">
                                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-597">Libellé accordéon</button>
                                            </h3>
                                            <div class="fr-collapse" id="accordion-597">
                                                <!-- données de test -->
                                                <div>
                                                    <h4 class="fr-h4">Contenu </h4>
                                                    <img class="fr-responsive-img" src="../../../../example/img/placeholder.16x9.png" alt="" />
                                        ...
                                        <section class="fr-accordion">
                                            <h3 class="fr-accordion__title">
                                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-598">Libellé accordéon</button>
                                            </h3>
                                            <div class="fr-collapse" id="accordion-598">
                                                <!-- données de test -->
                                                <div>
                                                    <h4 class="fr-h4">Contenu </h4>
                                                    <ul>
                            ...
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-606">Libellé accordéon</button>
                                </h3>
                                <div class="fr-collapse" id="accordion-606">
                                    <div class="fr-accordions-group">
                                        <section class="fr-accordion">
                                            <h3 class="fr-accordion__title">
                                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-600">Libellé accordéon</button>
                                            </h3>
                                            <div class="fr-collapse" id="accordion-600">
                                                <!-- données de test -->
                                                <div>
                                                    <h4 class="fr-h4">Contenu </h4>
                                                    <ul>
                                        ...
                                        <section class="fr-accordion">
                                            <h3 class="fr-accordion__title">
                                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-601">Libellé accordéon</button>
                                            </h3>
                                            <div class="fr-collapse" id="accordion-601">
                                                <!-- données de test -->
                                                <div>
                                                    <h4 class="fr-h4">Contenu </h4>
                                                    <img class="fr-responsive-img" src="../../../../example/img/placeholder.16x9.png" alt="" />
                                        ...
                                        <section class="fr-accordion">
                                            <h3 class="fr-accordion__title">
                                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-602">Libellé accordéon</button>
                                            </h3>
                                            <div class="fr-collapse" id="accordion-602">
                                                <!-- données de test -->
                                                <div>
                                                    <h4 class="fr-h4">Contenu </h4>
                                                    <ul>
                                        ...
                                        <section class="fr-accordion">
                                            <h3 class="fr-accordion__title">
                                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-603">Libellé accordéon</button>
                                            </h3>
                                            <div class="fr-collapse" id="accordion-603">
                                                <!-- données de test -->
                                                <div>
                                                    <h4 class="fr-h4">Contenu </h4>
                                                    <img class="fr-responsive-img" src="../../../../example/img/placeholder.16x9.png" alt="" />
                                        ...
                                        <section class="fr-accordion">
                                            <h3 class="fr-accordion__title">
                                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-604">Libellé accordéon</button>
                                            </h3>
                                            <div class="fr-collapse" id="accordion-604">
                                                <!-- données de test -->
                                                <div>
                                                    <h4 class="fr-h4">Contenu </h4>
                                                    <img class="fr-responsive-img" src="../../../../example/img/placeholder.16x9.png" alt="" />
                                        ...
                                        <section class="fr-accordion">
                                            <h3 class="fr-accordion__title">
                                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-605">Libellé accordéon</button>
                                            </h3>
                                            <div class="fr-collapse" id="accordion-605">
                                                <!-- données de test -->
                                                <div>
                                                    <h4 class="fr-h4">Contenu </h4>
                                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing, <a href="https://www.systeme-de-design.gouv.fr/" target="_blank">link test</a> incididunt, ut labore et dolore magna aliqua. Vitae sapien pellentesque habitant morbi tristique senectus et. Diam maecenas sed enim ut. Accumsan lacus vel facilisis volutpat est. Ut aliquam purus sit amet luctus. Lorem ipsum dolor sit amet consectetur adipiscing elit ut.</p>
                            ...
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-613">Libellé accordéon</button>
                                </h3>
                                <div class="fr-collapse" id="accordion-613">
                                    <div class="fr-accordions-group">
                                        <section class="fr-accordion">
                                            <h3 class="fr-accordion__title">
                                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-607">Libellé accordéon</button>
                                            </h3>
                                        ...
                                        <section class="fr-accordion">
                                            <h3 class="fr-accordion__title">
                                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-608">Libellé accordéon</button>
                                            </h3>
                                            <div class="fr-collapse" id="accordion-608">
                                                <!-- données de test -->
                                                <div>
                                                    <h4 class="fr-h4">Contenu </h4>
                                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing, <a href="https://www.systeme-de-design.gouv.fr/" target="_blank">link test</a> incididunt, ut labore et dolore magna aliqua. Vitae sapien pellentesque habitant morbi tristique senectus et. Diam maecenas sed enim ut. Accumsan lacus vel facilisis volutpat est. Ut aliquam purus sit amet luctus. Lorem ipsum dolor sit amet consectetur adipiscing elit ut.</p>
                                        ...
                                        <section class="fr-accordion">
                                            <h3 class="fr-accordion__title">
                                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-609">Libellé accordéon</button>
                                            </h3>
                                            <div class="fr-collapse" id="accordion-609">
                                                <!-- données de test -->
                                                <div>
                                                    <h4 class="fr-h4">Contenu </h4>
                                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing, <a href="https://www.systeme-de-design.gouv.fr/" target="_blank">link test</a> incididunt, ut labore et dolore magna aliqua. Vitae sapien pellentesque habitant morbi tristique senectus et. Diam maecenas sed enim ut. Accumsan lacus vel facilisis volutpat est. Ut aliquam purus sit amet luctus. Lorem ipsum dolor sit amet consectetur adipiscing elit ut.</p>
                                        ...
                                        <section class="fr-accordion">
                                            <h3 class="fr-accordion__title">
                                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-610">Libellé accordéon</button>
                                            </h3>
                                            <div class="fr-collapse" id="accordion-610">
                                                <!-- données de test -->
                                                <div>
                                                    <h4 class="fr-h4">Contenu </h4>
                                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing, <a href="https://www.systeme-de-design.gouv.fr/" target="_blank">link test</a> incididunt, ut labore et dolore magna aliqua. Vitae sapien pellentesque habitant morbi tristique senectus et. Diam maecenas sed enim ut. Accumsan lacus vel facilisis volutpat est. Ut aliquam purus sit amet luctus. Lorem ipsum dolor sit amet consectetur adipiscing elit ut.</p>
                                        ...
                                        <section class="fr-accordion">
                                            <h3 class="fr-accordion__title">
                                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-611">Libellé accordéon</button>
                                            </h3>
                                            <div class="fr-collapse" id="accordion-611">
                                                <!-- données de test -->
                                                <div>
                                                    <h4 class="fr-h4">Contenu </h4>
                                                    <img class="fr-responsive-img" src="../../../../example/img/placeholder.16x9.png" alt="" />
                                        ...
                                        <section class="fr-accordion">
                                            <h3 class="fr-accordion__title">
                                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-612">Libellé accordéon</button>
                                            </h3>
                                            <div class="fr-collapse" id="accordion-612">
                                                <!-- données de test -->
                                                <div>
                                                    <h4 class="fr-h4">Contenu </h4>
                                                    <img class="fr-responsive-img" src="../../../../example/img/placeholder.16x9.png" alt="" />
                            ...
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-620">Libellé accordéon</button>
                                </h3>
                                <div class="fr-collapse" id="accordion-620">
                                    <div class="fr-accordions-group">
                                        <section class="fr-accordion">
                                            <h3 class="fr-accordion__title">
                                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-614">Libellé accordéon</button>
                                            </h3>
                                        ...
                                        <section class="fr-accordion">
                                            <h3 class="fr-accordion__title">
                                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-615">Libellé accordéon</button>
                                            </h3>
                                            <div class="fr-collapse" id="accordion-615">
                                                <!-- données de test -->
                                                <div>
                                                    <h4 class="fr-h4">Contenu </h4>
                                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing, <a href="https://www.systeme-de-design.gouv.fr/" target="_blank">link test</a> incididunt, ut labore et dolore magna aliqua. Vitae sapien pellentesque habitant morbi tristique senectus et. Diam maecenas sed enim ut. Accumsan lacus vel facilisis volutpat est. Ut aliquam purus sit amet luctus. Lorem ipsum dolor sit amet consectetur adipiscing elit ut.</p>
                                        ...
                                        <section class="fr-accordion">
                                            <h3 class="fr-accordion__title">
                                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-616">Libellé accordéon</button>
                                            </h3>
                                            <div class="fr-collapse" id="accordion-616">
                                                <!-- données de test -->
                                                <div>
                                                    <h4 class="fr-h4">Contenu </h4>
                                                    <ul>
                                        ...
                                        <section class="fr-accordion">
                                            <h3 class="fr-accordion__title">
                                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-617">Libellé accordéon</button>
                                            </h3>
                                            <div class="fr-collapse" id="accordion-617">
                                                <!-- données de test -->
                                                <div>
                                                    <h4 class="fr-h4">Contenu </h4>
                                                    <img class="fr-responsive-img" src="../../../../example/img/placeholder.16x9.png" alt="" />
                                        ...
                                        <section class="fr-accordion">
                                            <h3 class="fr-accordion__title">
                                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-618">Libellé accordéon</button>
                                            </h3>
                                            <div class="fr-collapse" id="accordion-618">
                                                <!-- données de test -->
                                                <div>
                                                    <h4 class="fr-h4">Contenu </h4>
                                                    <img class="fr-responsive-img" src="../../../../example/img/placeholder.16x9.png" alt="" />
                                        ...
                                        <section class="fr-accordion">
                                            <h3 class="fr-accordion__title">
                                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-619">Libellé accordéon</button>
                                            </h3>
                                            <div class="fr-collapse" id="accordion-619">
                                                <!-- données de test -->
                                                <div>
                                                    <h4 class="fr-h4">Contenu </h4>
                                                    <ul>
                            ...
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-627">Libellé accordéon</button>
                                </h3>
                                <div class="fr-collapse" id="accordion-627">
                                    <div class="fr-accordions-group">
                                        <section class="fr-accordion">
                                            <h3 class="fr-accordion__title">
                                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-621">Libellé accordéon</button>
                                            </h3>
                                            <div class="fr-collapse" id="accordion-621">
                                                <!-- données de test -->
                                                <div>
                                                    <h4 class="fr-h4">Contenu </h4>
                                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing, <a href="https://www.systeme-de-design.gouv.fr/" target="_blank">link test</a> incididunt, ut labore et dolore magna aliqua. Vitae sapien pellentesque habitant morbi tristique senectus et. Diam maecenas sed enim ut. Accumsan lacus vel facilisis volutpat est. Ut aliquam purus sit amet luctus. Lorem ipsum dolor sit amet consectetur adipiscing elit ut.</p>
                                        ...
                                        <section class="fr-accordion">
                                            <h3 class="fr-accordion__title">
                                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-622">Libellé accordéon</button>
                                            </h3>
                                            <div class="fr-collapse" id="accordion-622">
                                                <!-- données de test -->
                                                <div>
                                                    <h4 class="fr-h4">Contenu </h4>
                                                    <img class="fr-responsive-img" src="../../../../example/img/placeholder.16x9.png" alt="" />
                                        ...
                                        <section class="fr-accordion">
                                            <h3 class="fr-accordion__title">
                                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-623">Libellé accordéon</button>
                                            </h3>
                                            <div class="fr-collapse" id="accordion-623">
                                                <!-- données de test -->
                                                <div>
                                                    <h4 class="fr-h4">Contenu </h4>
                                                    <ul>
                                        ...
                                        <section class="fr-accordion">
                                            <h3 class="fr-accordion__title">
                                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-624">Libellé accordéon</button>
                                            </h3>
                                            <div class="fr-collapse" id="accordion-624">
                                                <!-- données de test -->
                                                <div>
                                                    <h4 class="fr-h4">Contenu </h4>
                                                    <img class="fr-responsive-img" src="../../../../example/img/placeholder.16x9.png" alt="" />
                                        ...
                                        <section class="fr-accordion">
                                            <h3 class="fr-accordion__title">
                                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-625">Libellé accordéon</button>
                                            </h3>
                                            <div class="fr-collapse" id="accordion-625">
                                                <!-- données de test -->
                                                <div>
                                                    <h4 class="fr-h4">Contenu </h4>
                                                    <img class="fr-responsive-img" src="../../../../example/img/placeholder.16x9.png" alt="" />
                                        ...
                                        <section class="fr-accordion">
                                            <h3 class="fr-accordion__title">
                                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-626">Libellé accordéon</button>
                                            </h3>
                                            <div class="fr-collapse" id="accordion-626">
                                                <!-- données de test -->
                                                <div>
                                                    <h4 class="fr-h4">Contenu </h4>
                                                    <img class="fr-responsive-img" src="../../../../example/img/placeholder.16x9.png" alt="" />
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-670">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-670">
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-671">Libellé accordéon</button>
                            </h3>
                            <div class="fr-collapse" id="accordion-671">
                                <div class="fr-tabs">
                                    <ul class="fr-tabs__list" role="tablist" aria-label="[A modifier | nom du système d'onglet]">
                                        <li role="presentation">
                                            <button type="button" id="tab-672" class="fr-tabs__tab" tabindex="0" role="tab" aria-selected="true" aria-controls="tab-672-panel">Libellé onglet 1</button>
                                        </li>
                                        <li role="presentation">
                                            <button type="button" id="tab-673" class="fr-tabs__tab" tabindex="-1" role="tab" aria-selected="false" aria-controls="tab-673-panel">Libellé onglet 2</button>
                                        </li>
                                    </ul>
                                    <div id="tab-672-panel" class="fr-tabs__panel fr-tabs__panel--selected" role="tabpanel" aria-labelledby="tab-672" tabindex="0">
                                        <!-- données de test -->
                                        <div>
                                    ...
                                    <div id="tab-673-panel" class="fr-tabs__panel" role="tabpanel" aria-labelledby="tab-673" tabindex="0">
                                        <!-- données de test -->
                                        <div>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-677">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-677">
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button aria-controls="fr-theme-modal" title="Fermer" type="button" id="button-678" class="fr-btn--close fr-btn">Fermer</button>
                        </div>
