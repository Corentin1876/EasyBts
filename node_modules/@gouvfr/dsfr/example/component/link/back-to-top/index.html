        ...
        <div class="fr-container">
            <div class="fr-grid-row fr-grid-row--center">
                <div class="fr-col-md-8 fr-col-12">
                    ...
                    <div class="fr-mb-6v">
                        <a id="link-4236" href="#top" class="fr-link fr-icon-arrow-up-fill fr-link--icon-left">Haut de page</a>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4238">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4238">
                                <pre class=" language-html"><code>&lt;a id="link-4237" href="#top" class="fr-link fr-icon-arrow-up-fill fr-link--icon-left"&gt;Haut de page&lt;/a&gt;
</code></pre>
                            </div>
                        </section>
                    </div>
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button aria-controls="fr-theme-modal" title="Fermer" type="button" id="button-4239" class="fr-btn--close fr-btn">Fermer</button>
                        </div>
