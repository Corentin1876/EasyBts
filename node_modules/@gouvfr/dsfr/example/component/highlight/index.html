...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <a href="https://www.systeme-de-design.gouv.fr/version-courante/fr/composants/mise-en-exergue" rel="noopener external" target="_blank" title="${getBlankTitle('Documentation')}">Documentation</a>
    </div>
    <div class="fr-mb-12w">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-5652">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-5652">
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-5653">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-5653">
                                <pre class=" language-html"><code>&lt;div class="fr-highlight"&gt;
    &lt;p&gt;Lorem [...] elit ut.&lt;/p&gt;
&lt;/div&gt;
</code></pre>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-5654">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-5654">
                                <pre class=" language-html"><code>&lt;div class="fr-highlight"&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-5655">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-5655">
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button aria-controls="fr-theme-modal" title="Fermer" type="button" id="button-5656" class="fr-btn--close fr-btn">Fermer</button>
                        </div>
