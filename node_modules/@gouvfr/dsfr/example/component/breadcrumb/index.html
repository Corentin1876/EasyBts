                ...
                <div class="fr-col-md-8 fr-col-12">
                    ...
                    <div class="fr-mb-6v">
                        <nav role="navigation" class="fr-breadcrumb" aria-label="vous êtes ici :">
                            <button type="button" class="fr-breadcrumb__button" aria-expanded="false" aria-controls="breadcrumb-3698">Voir le fil d’Ariane</button>
                            <div class="fr-collapse" id="breadcrumb-3698">
                                <ol class="fr-breadcrumb__list">
                                    <li>
                                        <a class="fr-breadcrumb__link" id="breadcrumb-3690" href="../">Accueil</a>
                                    </li>
                                    <li>
                                        <a class="fr-breadcrumb__link" id="breadcrumb-3691" href="../">Segment 1: lorem ipsum</a>
                                    </li>
                                    <li>
                                        <a class="fr-breadcrumb__link" id="breadcrumb-3692" href="../">Segment 2: lorem ipsum</a>
                                    </li>
                                    <li>
                                        <a class="fr-breadcrumb__link" id="breadcrumb-3693" href="../">Segment 3: lorem ipsum</a>
                                    </li>
                                    <li>
                                        <a class="fr-breadcrumb__link" id="breadcrumb-3694" href="../">Segment 4: lorem ipsum</a>
                                    </li>
                                    <li>
                                        <a class="fr-breadcrumb__link" id="breadcrumb-3695" href="../">Segment 5: lorem ipsum</a>
                                    </li>
                                    <li>
                                        <a class="fr-breadcrumb__link" id="breadcrumb-3696" href="../">Segment 6: lorem ipsum</a>
                                    </li>
                                    <li>
                                        <a class="fr-breadcrumb__link" id="breadcrumb-3697" href="../">Segment 7: lorem ipsum</a>
                                    </li>
                                    <li>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-3708">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-3708">
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button aria-controls="fr-theme-modal" title="Fermer" type="button" id="button-3709" class="fr-btn--close fr-btn">Fermer</button>
                        </div>
