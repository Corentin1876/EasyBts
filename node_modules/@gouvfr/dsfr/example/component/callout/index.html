...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <a href="https://www.systeme-de-design.gouv.fr/version-courante/fr/composants/mise-en-avant" rel="noopener external" target="_blank" title="${getBlankTitle('Documentation')}">Documentation</a>
    </div>
    <div class="fr-mb-12w">
        <div class="fr-container">
            <div class="fr-grid-row fr-grid-row--center">
                <div class="fr-col-md-8 fr-col-12">
                    ...
                    <div class="fr-mb-6v">
                        <div id="callout-5636" class="fr-callout">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-5638">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-5638">
                                <pre class=" language-html"><code>&lt;div id="callout-5637" class="fr-callout"&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div id="callout-5639" class="fr-callout">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-5641">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-5641">
                                <pre class=" language-html"><code>&lt;div id="callout-5640" class="fr-callout"&gt;
    &lt;h3 class="fr-callout__title"&gt;Titre mise en avant&lt;/h3&gt;
    &lt;p class="fr-callout__text"&gt;Lorem [...] elit ut.&lt;/p&gt;
&lt;/div&gt;
</code></pre>
                    ...
                    <div class="fr-mb-6v">
                        <div id="callout-5642" class="fr-callout">
                            <h3 class="fr-callout__title">Titre mise en avant</h3>
                            <p class="fr-callout__text">Lorem ipsum dolor sit amet, consectetur adipiscing, incididunt, ut labore et dolore magna aliqua. Vitae sapien pellentesque habitant morbi tristique senectus et. Diam maecenas sed </p>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-5644">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-5644">
                                <pre class=" language-html"><code>&lt;div id="callout-5643" class="fr-callout"&gt;
    &lt;h3 class="fr-callout__title"&gt;Titre mise en avant&lt;/h3&gt;
    &lt;p class="fr-callout__text"&gt;Lorem [...] elit ut.&lt;/p&gt;
    &lt;button type="button" class="fr-btn"&gt;Libellé bouton&lt;/button&gt;
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div id="callout-5645" class="fr-callout fr-icon-info-line">
                            <h3 class="fr-callout__title">Titre mise en avant</h3>
                            <p class="fr-callout__text">Lorem ipsum dolor sit amet, consectetur adipiscing, incididunt, ut labore et dolore magna aliqua. Vitae sapien pellentesque habitant morbi tristique senectus et. Diam maecenas sed </p>
                            <button type="button" class="fr-btn">Libellé bouton</button>
                        </div>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-5647">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-5647">
                                <pre class=" language-html"><code>&lt;div id="callout-5646" class="fr-callout fr-icon-info-line"&gt;
    &lt;h3 class="fr-callout__title"&gt;Titre mise en avant&lt;/h3&gt;
    &lt;p class="fr-callout__text"&gt;Lorem [...] elit ut.&lt;/p&gt;
    &lt;button type="button" class="fr-btn"&gt;Libellé bouton&lt;/button&gt;
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div id="callout-5648" class="fr-callout fr-callout--green-emeraude">
                            <h3 class="fr-callout__title">Titre mise en avant</h3>
                            <p class="fr-callout__text">Lorem ipsum dolor sit amet, consectetur adipiscing, incididunt, ut labore et dolore magna aliqua. Vitae sapien pellentesque habitant morbi tristique senectus et. Diam maecenas sed </p>
                        </div>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-5650">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-5650">
                                <pre class=" language-html"><code>&lt;div id="callout-5649" class="fr-callout fr-callout--green-emeraude"&gt;
    &lt;h3 class="fr-callout__title"&gt;Titre mise en avant&lt;/h3&gt;
    &lt;p class="fr-callout__text"&gt;Lorem [...] elit ut.&lt;/p&gt;
&lt;/div&gt;
</code></pre>
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button aria-controls="fr-theme-modal" title="Fermer" type="button" id="button-5651" class="fr-btn--close fr-btn">Fermer</button>
                        </div>
