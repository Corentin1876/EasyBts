        ...
        <div class="fr-container">
            <div class="fr-grid-row fr-grid-row--center">
                <div class="fr-col-md-8 fr-col-12">
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-input-group" id="input-group-1502">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1504">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1504">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group" id="input-group-1503"&gt;
    &lt;label class="fr-label" for="text-input-text"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
    &lt;input class="fr-input" aria-describedby="text-input-text-messages" id="text-input-text" type="text"&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-input-group" id="input-group-1505">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1507">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1507">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group" id="input-group-1506"&gt;
    &lt;label class="fr-label" for="text-input-number"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
    &lt;input class="fr-input" pattern="[0-9]*" inputmode="numeric" aria-describedby="text-input-number-messages" id="text-input-number" type="number"&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-input-group" id="input-group-1508">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1510">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1510">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group" id="input-group-1509"&gt;
    &lt;label class="fr-label" for="text-input-search"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
    &lt;input class="fr-input" aria-describedby="text-input-search-messages" id="text-input-search" type="search"&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-input-group" id="input-group-1511">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            ...
                            <div class="fr-collapse" id="snippet-1513">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group" id="input-group-1512"&gt;
    &lt;label class="fr-label" for="text-input-date"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
    &lt;input class="fr-input" aria-describedby="text-input-date-messages" id="text-input-date" type="date"&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-input-group" id="input-group-1514">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            ...
                            <div class="fr-collapse" id="snippet-1516">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group" id="input-group-1515"&gt;
    &lt;label class="fr-label" for="textarea"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
    &lt;textarea class="fr-input" aria-describedby="textarea-messages" id="textarea"&gt;&lt;/textarea&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-input-group" id="input-group-1517">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1519">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1519">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group" id="input-group-1518"&gt;
    &lt;label class="fr-label" for="text-input-password"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
    &lt;input class="fr-input" aria-describedby="text-input-password-messages" id="text-input-password" type="password"&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-input-group" id="input-group-1520">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1522">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1522">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group" id="input-group-1521"&gt;
    &lt;label class="fr-label" for="text-input-button"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
    &lt;div class="fr-input-wrap fr-input-wrap--addon"&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-input-group" id="input-group-1523">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1525">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1525">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group" id="input-group-1524"&gt;
    &lt;label class="fr-label" for="text-input-action"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
    &lt;div class="fr-input-wrap fr-input-wrap--action"&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-input-group" id="input-group-1526">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1528">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1528">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group" id="input-group-1527"&gt;
    &lt;label class="fr-label" for="text-input-placeholder"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
    &lt;input class="fr-input" aria-describedby="text-input-placeholder-messages" placeholder="placeholder" id="text-input-placeholder" type="text"&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-input-group" id="input-group-1529">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1531">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1531">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group" id="input-group-1530"&gt;
    &lt;label class="fr-label" for="text-input-value"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
    &lt;input class="fr-input" value="value" aria-describedby="text-input-value-messages" id="text-input-value" type="text"&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-input-group" id="input-group-1532">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1534">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1534">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group" id="input-group-1533"&gt;
    &lt;label class="fr-label" for="text-input-icon"&gt;
        Libellé champ de saisie
        &lt;span class="fr-hint-text"&gt;Texte de description additionnel&lt;/span&gt;
    &lt;/label&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-input-group fr-input-group--disabled" id="input-group-1535">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1537">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1537">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group fr-input-group--disabled" id="input-group-1536"&gt;
    &lt;label class="fr-label" for="text-input-disabled"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
    &lt;input class="fr-input" aria-describedby="text-input-disabled-messages" disabled id="text-input-disabled" type="text"&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-input-group" id="input-group-1538">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1540">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1540">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group" id="input-group-1539"&gt;
    &lt;label class="fr-label" for="text-input-hint"&gt;
        Libellé champ de saisie
        &lt;span class="fr-hint-text"&gt;Texte de description additionnel&lt;/span&gt;
    &lt;/label&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-input-group fr-input-group--valid" id="input-group-1541">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1543">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1543">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group fr-input-group--valid" id="input-group-1542"&gt;
    &lt;label class="fr-label" for="text-input-valid"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
    &lt;input class="fr-input" aria-describedby="text-input-valid-messages" id="text-input-valid" type="text"&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-input-group fr-input-group--error" id="input-group-1544">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1546">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1546">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group fr-input-group--error" id="input-group-1545"&gt;
    &lt;label class="fr-label" for="text-input-error"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
    &lt;input class="fr-input" aria-describedby="text-input-error-messages" id="text-input-error" type="text"&gt;
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button aria-controls="fr-theme-modal" title="Fermer" type="button" id="button-1547" class="fr-btn--close fr-btn">Fermer</button>
                        </div>
