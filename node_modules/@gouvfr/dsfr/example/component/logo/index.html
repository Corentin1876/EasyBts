                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-965">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-965">
...
&lt;/p&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-966">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-966">
...
&lt;/p&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-967">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-967">
...
&lt;/p&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-968">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-968">
                                <pre class=" language-html"><code>&lt;p class="fr-logo"&gt;
    Ministère
    &lt;br&gt;de la transition
    &lt;br&gt;écologique
...
&lt;/p&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-969">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-969">
                                <pre class=" language-html"><code>&lt;p class="fr-logo"&gt;
    Secrétaire d’État
    &lt;br&gt;chargé(e) de
    &lt;br&gt;l’égalité entre les
...
&lt;/p&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-970">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-970">
                                <pre class=" language-html"><code>&lt;p class="fr-logo"&gt;
    Ministère
    &lt;br&gt;de l’europe
    &lt;br&gt;et des affaires
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button aria-controls="fr-theme-modal" title="Fermer" type="button" id="button-971" class="fr-btn--close fr-btn">Fermer</button>
                        </div>
