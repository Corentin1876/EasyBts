...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <a href="https://www.systeme-de-design.gouv.fr/version-courante/fr/composants/barre-de-recherche" rel="noopener external" target="_blank" title="${getBlankTitle('Documentation')}">Documentation</a>
    </div>
    <div class="fr-mb-12w">
        <div class="fr-container">
            <div class="fr-grid-row fr-grid-row--center">
                <div class="fr-col-md-8 fr-col-12">
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-search-bar" id="search-954" role="search">
                            <label class="fr-label" for="search-954-input">
                                Rechercher
                            </label>
                            <input class="fr-input" aria-describedby="search-954-input-messages" placeholder="Rechercher" id="search-954-input" type="search">
                            <div class="fr-messages-group" id="search-954-input-messages" aria-live="polite">
                            </div>
                            <button title="Rechercher" type="button" id="search-btn-955" class="fr-btn">Rechercher</button>
                        </div>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-958">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-958">
                                <pre class=" language-html"><code>&lt;div class="fr-search-bar" id="search-956" role="search"&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-search-bar fr-search-bar--lg" id="search-959" role="search">
                            <label class="fr-label" for="search-959-input">
                                Rechercher
                            </label>
                            <input class="fr-input" aria-describedby="search-959-input-messages" placeholder="Rechercher" id="search-959-input" type="search">
                            <div class="fr-messages-group" id="search-959-input-messages" aria-live="polite">
                            </div>
                            <button type="button" id="search-btn-960" class="fr-btn">Rechercher</button>
                        </div>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            ...
                            <div class="fr-collapse" id="snippet-963">
                                <pre class=" language-html"><code>&lt;div class="fr-search-bar fr-search-bar--lg" id="search-961" role="search"&gt;
