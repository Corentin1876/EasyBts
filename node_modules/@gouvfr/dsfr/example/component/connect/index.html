...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <a href="https://www.systeme-de-design.gouv.fr/version-courante/fr/composants/bouton-franceconnect" rel="noopener external" target="_blank" title="${getBlankTitle('Documentation')}">Documentation</a>
    </div>
    <div class="fr-mb-12w">
                ...
                <div class="fr-col-md-8 fr-col-12">
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-connect-group">
                            <button class="fr-connect" id="connect-1066" type="button">
                                <span class="fr-connect__login">S’identifier avec</span>
                                <span class="fr-connect__brand">FranceConnect</span>
                            </button>
                            <p>
                                <a href="https://franceconnect.gouv.fr/" id="connect-link-1067" target="_blank" rel="noopener" title="Qu’est-ce que FranceConnect ? - nouvelle fenêtre">Qu’est-ce que FranceConnect ?</a>
                            </p>
                        </div>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1070">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1070">
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-connect-group">
                            <button class="fr-connect fr-connect--plus" id="connect-1071" type="button">
                                <span class="fr-connect__login">S’identifier avec</span>
                                <span class="fr-connect__brand">FranceConnect</span>
                            </button>
                            <p>
                                <a href="https://franceconnect.gouv.fr/france-connect-plus" id="connect-link-1072" target="_blank" rel="noopener" title="Qu’est-ce que FranceConnect+ ? - nouvelle fenêtre">Qu’est-ce que FranceConnect+ ?</a>
                            </p>
                        </div>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            ...
                            <div class="fr-collapse" id="snippet-1075">
                                <pre class=" language-html"><code>&lt;div class="fr-connect-group"&gt;
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button aria-controls="fr-theme-modal" title="Fermer" type="button" id="button-1076" class="fr-btn--close fr-btn">Fermer</button>
                        </div>
