...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-mb-12w">
        <div class="fr-container">
            ...
            <h3>bouton</h3>
            <div class="fr-mb-6v">
                <button data-fr-analytics-action="libellé envoyé à l'analytics" type="button" id="button-521" class="fr-btn">Libellé button</button>
            </div>
            <div class="fr-mt-0">
            ...
            <h3>bouton</h3>
            <div class="fr-mb-6v">
                <button type="button" id="button-522" class="fr-btn">Libellé button</button>
            </div>
            <h3>bouton</h3>
            <div class="fr-mb-6v">
                <button type="button" id="button-523" class="fr-btn">Libellé button</button>
            </div>
            <div class="fr-mt-0">
            ...
            <div class="fr-mb-6v">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-524">Libellé accordéon</button>
                    </h3>
                    <div class="fr-collapse" data-fr-analytics-action="libellé envoyé à l'analytics" id="accordion-524">
                        <!-- données de test -->
                        <div>
            ...
            <div class="fr-mb-6v">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-525">Libellé accordéon</button>
                    </h3>
                    <div class="fr-collapse" id="accordion-525">
                        <!-- données de test -->
                        <div>
                            <h4 class="fr-h4">Contenu </h4>
                            <ul>
            ...
            <div class="fr-mb-6v">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-526">Libellé accordéon</button>
                    </h3>
                    <div class="fr-collapse" id="accordion-526">
                        <!-- données de test -->
                        <div>
                            <h4 class="fr-h4">Contenu </h4>
                            <img class="fr-responsive-img" src="../../../example/img/placeholder.16x9.png" alt="" />
