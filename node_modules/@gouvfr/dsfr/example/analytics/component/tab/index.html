                ...
                <div class="fr-tabs">
                    <ul class="fr-tabs__list" role="tablist" aria-label="[A modifier | nom du système d'onglet]">
                        <li role="presentation">
                            <button type="button" id="tab-505" class="fr-tabs__tab fr-icon-checkbox-circle-line fr-tabs__tab--icon-left" tabindex="0" role="tab" aria-selected="true" aria-controls="tab-505-panel">Libellé onglet 1</button>
                        </li>
                        <li role="presentation">
                            <button type="button" id="tab-506" class="fr-tabs__tab fr-icon-checkbox-circle-line fr-tabs__tab--icon-left" tabindex="-1" role="tab" aria-selected="false" aria-controls="tab-506-panel">Libellé onglet 2</button>
                        </li>
                        <li role="presentation">
                            <button type="button" id="tab-507" class="fr-tabs__tab fr-icon-checkbox-circle-line fr-tabs__tab--icon-left" tabindex="-1" role="tab" aria-selected="false" aria-controls="tab-507-panel">Libellé onglet 3</button>
                        </li>
                        <li role="presentation">
                            <button type="button" id="tab-508" class="fr-tabs__tab fr-icon-checkbox-circle-line fr-tabs__tab--icon-left" tabindex="-1" role="tab" aria-selected="false" aria-controls="tab-508-panel">Libellé onglet 4</button>
                        </li>
                    </ul>
                    <div id="tab-505-panel" class="fr-tabs__panel fr-tabs__panel--selected" role="tabpanel" aria-labelledby="tab-505" tabindex="0">
                        <!-- données de test -->
                        <div>
                    ...
                    <div id="tab-506-panel" class="fr-tabs__panel" role="tabpanel" aria-labelledby="tab-506" tabindex="0">
                        <!-- données de test -->
                        <div>
                    ...
                    <div id="tab-507-panel" class="fr-tabs__panel" role="tabpanel" aria-labelledby="tab-507" tabindex="0">
                        <!-- données de test -->
                        <div>
                    ...
                    <div id="tab-508-panel" class="fr-tabs__panel" role="tabpanel" aria-labelledby="tab-508" tabindex="0">
                        <!-- données de test -->
                        <div>
