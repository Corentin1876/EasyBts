...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-mb-12w">
        <div class="fr-container">
            <h3>En-tête</h3>
            <div class="fr-mb-6v">
                <header role="banner" class="fr-header" id="header-165">
                        ...
                        <div class="fr-container">
                            <div class="fr-header__body-row">
                                <div class="fr-header__brand fr-enlarge-link">
                                    <div class="fr-header__brand-top">
                                        ...
                                        <div class="fr-header__navbar">
                                            <button data-fr-opened="false" aria-controls="modal-167" title="Rechercher" type="button" id="button-168" class="fr-btn--search fr-btn">Rechercher</button>
                                            <button data-fr-opened="false" aria-controls="modal-169" title="Menu" type="button" id="button-170" class="fr-btn--menu fr-btn">Menu</button>
                                        </div>
                                    </div>
                                ...
                                <div class="fr-header__tools">
                                    ...
                                    <div class="fr-header__search fr-modal" id="modal-167" aria-labelledby="button-168">
                                        <div class="fr-container fr-container-lg--fluid">
                                            <button aria-controls="modal-167" title="Fermer" type="button" id="button-172" class="fr-btn--close fr-btn">Fermer</button>
                                            <div class="fr-search-bar" id="search-166" role="search">
                                                <label class="fr-label" for="search-166-input">
                                                    Rechercher
                                                </label>
                                                <input class="fr-input" aria-describedby="search-166-input-messages" placeholder="Rechercher" id="search-166-input" type="search">
                                                <div class="fr-messages-group" id="search-166-input-messages" aria-live="polite">
                                                </div>
                                                <button title="Rechercher" type="button" id="search-btn-174" class="fr-btn">Rechercher</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="fr-header__menu fr-modal" id="modal-169" aria-labelledby="button-170">
                        <div class="fr-container">
                            <button aria-controls="modal-169" title="Fermer" type="button" id="button-175" class="fr-btn--close fr-btn">Fermer</button>
                            <div class="fr-header__menu-links">
                            </div>
                            <nav class="fr-nav" id="navigation-176" role="navigation" aria-label="Menu principal">
                                <ul class="fr-nav__list">
                                    ...
                                    <li class="fr-nav__item">
                                        <a id="nav-179" type="link" href="#" class="fr-nav__link">accès direct nav-179</a>
                                    </li>
                                    <li class="fr-nav__item">
                                        <a id="nav-180" type="link" href="#" class="fr-nav__link">accès direct nav-180</a>
                                    </li>
                                </ul>
                            </nav>
                        </div>
