...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-mb-12w">
        <div class="fr-container">
            ...
            <div class="fr-mb-6v">
                <div class="fr-search-bar" id="search-354" role="search">
                    <label class="fr-label" for="search-354-input">
                        Rechercher
                    </label>
                    <input class="fr-input" aria-describedby="search-354-input-messages" placeholder="Rechercher" id="search-354-input" type="search">
                    <div class="fr-messages-group" id="search-354-input-messages" aria-live="polite">
                    </div>
                    <button title="Rechercher" type="button" id="search-btn-355" class="fr-btn">Rechercher</button>
                </div>
            </div>
        </div>
    </div>
