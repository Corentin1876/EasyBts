...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-mb-12w">
        <div class="fr-container">
            ...
            <div class="fr-mb-6v">
                <button data-fr-opened="false" aria-controls="modal-187" id="modal-187" type="button" class="fr-btn">Libellé bouton modale</button>
                <dialog id="modal-187" class="fr-modal" aria-labelledby="modal-187-title">
                    <div class="fr-container fr-container--fluid fr-container-md">
                        <div class="fr-grid-row fr-grid-row--center">
                            <div class="fr-col-12 fr-col-md-8 fr-col-lg-6">
                                <div class="fr-modal__body">
                                    <div class="fr-modal__header">
                                        <button aria-controls="modal-187" title="Fermer" type="button" id="button-188" class="fr-btn--close fr-btn">Fermer</button>
                                    </div>
                                    <div class="fr-modal__content">
                                        <h2 id="modal-187-title" class="fr-modal__title">
                                    ...
                                    <div class="fr-modal__footer">
                                        <div class="fr-btns-group fr-btns-group--right fr-btns-group--inline-reverse fr-btns-group--inline-lg fr-btns-group--icon-left">
                                            <button type="button" id="button-185" class="fr-btn fr-icon-checkbox-circle-line fr-btn--icon-left">Libellé bouton</button>
                                            <button type="button" id="button-186" class="fr-btn fr-icon-checkbox-circle-line fr-btn--icon-left fr-btn--secondary">Libellé bouton</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
