...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-mb-12w">
        <div class="fr-container">
            ...
            <div class="fr-mb-6v">
                <div class="fr-toggle">
                    <input type="checkbox" class="fr-toggle__input" id="toggle-511" checked aria-describedby="toggle-511-messages">
                    <label class="fr-toggle__label" for="toggle-511" data-fr-checked-label="Activé" data-fr-unchecked-label="Désactivé">Libellé de l'interrupteur</label>
                    <div class="fr-messages-group" id="toggle-511-messages" aria-live="polite">
                    </div>
                </div>
            </div>
        </div>
