...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-mb-12w">
        <div class="fr-container">
            ...
            <div class="fr-mb-6v">
                <div class="fr-toggle">
                    <input type="checkbox" class="fr-toggle__input" id="toggle-510" aria-describedby="toggle-510-messages">
                    <label class="fr-toggle__label" for="toggle-510" data-fr-checked-label="Activé" data-fr-unchecked-label="Désactivé">Libellé de l'interrupteur</label>
                    <div class="fr-messages-group" id="toggle-510-messages" aria-live="polite">
                    </div>
                </div>
            </div>
        </div>
